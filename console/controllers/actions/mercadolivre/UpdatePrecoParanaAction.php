...
class UpdatePrecoParanaAction extends Action
{
    public function run()
    {
        $nome_arquivo = "/var/tmp/log_update_preco_ml_Parana_".date("Y-m-d_H-i-s").".csv";
        ...
        $filial = Filial::find()->andWhere(['=','id',76])->one();
