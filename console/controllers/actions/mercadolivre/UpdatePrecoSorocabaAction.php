...
class UpdatePrecoSorocabaAction extends Action
{
    public function run()
    {
        $nome_arquivo = "/var/tmp/log_update_preco_ml_Sorocaba_".date("Y-m-d_H-i-s").".csv";
        ...
        $filial = Filial::find()->andWhere(['=','id',59])->one();
