...
class CreateSPDuplicadaAction extends Action
{
    public function run()
    {
                ...
                foreach ($produtoFilials as $k => $produtoFilial) {  
                  ...
                  /*  if($k < 357 ){
                   ...
                   // die;               
                    ...
                    $titulo_novo = str_replace('iveco','',$titulo_novo);
                    $titulo_novo = str_replace('IVECO','',$titulo_novo);
                    $titulo_novo = str_replace('Iveco','',$titulo_novo);
                    ...
                    foreach ($produtos_filiais_conta_duplicada as $i => $produto_filial_conta_duplicada) {
                        //print_r($produto_filial_conta_duplicada);
                        //die;
