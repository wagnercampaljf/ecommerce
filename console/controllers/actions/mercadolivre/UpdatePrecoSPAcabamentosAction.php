...
class UpdatePrecoSPAcabamentosAction extends Action
{
    public function run()
    {
        $nome_arquivo = "/var/tmp/log_update_preco_ml_SPAcabamentos_".date("Y-m-d_H-i-s").".csv";
        ...
        $filial = Filial::find()->andWhere(['=','id',86])->one();
