...
class UpdateEANSP2Action extends Action
{
    public function run()
    {
        ...
        $filials = Filial::find()
            ...
            //->andWhere(['id' => [84]])
            //->andWhere(['id' => [8,38,43,59,60,62,69,72,76,77,78,84,86,87,88,89,90,95,96,97]])
            ->andWhere(['id' => [72,76,77,78,84,86,87,88,89,90,95,96,97]])
            //->andWhere(['<>','id', 98])
    	    ->orderBy('id')
            ->all();
