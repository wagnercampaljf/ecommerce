...
class UpdateFichaTecnicaAction extends Action
{
    public function run()
    {
        ...
        $nome_arquivo = "2021_produtos_ficha_tecnica_04.csv";
        ...
        // $user = $meli->refreshAccessToken('TG-5f7b39a0f7091400062479e0-193724256');
        ...
        if (is_object($response) && ArrayHelper::getValue($user, 'httpCode') < 400) {
            ...
            while (($linha = fgetcsv($file, null, ';')) !== false) {
                 ...
                 //if($linha[0] != "MLB1832678208"){continue;}
