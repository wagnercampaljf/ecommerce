...
class ImportacaoImagemVannucciAction extends Action
{
    public function run(){
        ...
        $path = "/var/tmp/vannucci_1115_2083/com_logo/";
        ...
        while($arquivo = $diretorio -> read()){
            ...
            $caminhoImagemSemLogo       = "/var/tmp/vannucci_1115_2083/sem_logo/".str_replace(" cópia","",$arquivo);

            $codigo_fabricante          = str_replace(" cópia.jpg","",$arquivo);
