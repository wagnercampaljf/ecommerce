...
class CorrigirProdutoTodosAction extends Action
{
    public function run($codigo_global)
    {
        ...
        $produtos_corrigir = Array();
        $file = fopen("/var/tmp/omie_corrigir_produtos_10-07-2020.csv", 'r');
        while (($line = fgetcsv($file,null,';')) !== false)
        {
            $produtos_corrigir[] = $line[1];
        }
        fclose($file);
