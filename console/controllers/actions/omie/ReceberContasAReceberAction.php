...
class ReceberContasAReceberAction extends Action
{
    public function run()
    {
        ...
        $arquivo_log        = fopen("/var/tmp/receber_pedidos_ml_omie/log_contas_receber_atrasado_".date("Y-m-d_H-i-s").".csv", "a");
        ...
        $x = 0;
        $y = 0;
        $data_inicial 	= "2021-05-24";//"2020-10-01";
        ...
        //Baseado no backend
        $arquivo_pedidos_nome = "/var/tmp/receber_pedidos_ml_omie/pedidos_2021-05-31.csv";
        ...
        $body = [
            ...
            "param" => [
                ...
                "filtrar_por_data_de" => "24/05/2021",//"01/01/2010",
                        ...
                        if(array_key_exists("pedido_venda_produto",$response_pedido["body"])){
                            if(array_key_exists("cabecalho",$response_pedido["body"]["pedido_venda_produto"])){                        
                                if(array_key_exists("codigo_pedido_integracao",$response_pedido["body"]["pedido_venda_produto"]["cabecalho"])){
                                    ...
                                    $codigo_integracao = $response_pedido["body"]["pedido_venda_produto"]["cabecalho"]["codigo_pedido_integracao"];
                                    $tipo   = 'PI';
                                    $pos = strpos($codigo_integracao, $tipo);
