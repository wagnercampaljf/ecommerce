...
class SincronizarEstoqueAutomaticoMG4Action extends Action
{
    public function run()
    {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //Movimentação de ajuste de estoque
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        
        $movimentacao_estoque_mestre                        = new MovimentacaoEstoqueMestre;
        $movimentacao_estoque_mestre->descricao             = "Movimentação de Estoque (Sincronização de estoque - MG4 => SP2) - ".date("Y-m-d H-i-s");
        ...
        $movimentacao_estoque_mestre->filial_origem_id      = 93;
        $movimentacao_estoque_mestre->filial_destino_id     = 96;
                ...
                foreach($response_omie_posicao_estoque["body"]["produtos"] as $k => $produto_estoque){
                    ...
                    if($estoque > 0){
                        ...
                        $body = [
                            ...
                            "param" => [
                                "cod_int"   => $produto_estoque["cCodigo"],
                                "data"      => date("d/m/Y")
                            ]
                        ];
                        
                        $response_consulta_estoque_sp2 = $omie->consulta("/api/v1/estoque/consulta/?JSON=",$body);
                        //print_r($response_consulta_estoque_sp2);
                        
                        if($response_consulta_estoque_sp2["httpCode"] == 200){
                            
                            $quantidade_sp2 = $response_consulta_estoque_sp2["body"]["saldo"];
                            echo " - sp2: (".$quantidade_sp2.")";
                            
                            if($quantidade_sp2 < 0){
                                
                                echo " - quantidde negativa em SP2";
                                $quantidade_sp2 = (-1)*$quantidade_sp2;
                                $quantidade_a_transferir = ($estoque <= $quantidade_sp2) ? $estoque : $quantidade_sp2;
                                ...
                                $movimentacao_estoque_detalhe->descricao                        = $produto_estoque["cCodigo"]." | ".$produto_estoque["cDescricao"];
                                ...
                                $codigo_produto_omie = $produto_estoque["cCodigo"];
                                ...
                                $body = [
                                    ...
                                    "app_secret" => $APP_SECRET_OMIE_CONTA_MG4,
                                    "param" => [
                                        "codigo_local_estoque"  => 2388359502,
                                        "id_prod"               => $produto_estoque["nCodProd"],
                                ...
                                if($response["httpCode"] == 200){
                                    echo " - Produto encontrado pelo PA no Omie principal";
                                    
                                    $codigo_produto_omie_principal = $response["body"]["codigo_produto"];
                                    ...
                                    $body = [
                                        ...
                                        "param" => [
                                            ...
                                            "id_prod"               => $codigo_produto_omie_principal,
                                            "data"                  => date("d/m/Y"),//"29/10/2021",
                                            "quan"                  => $quantidade_a_transferir,
                                            "obs"                   => "Ajuste feito pela API (ID movimentacao_estoque_mestre: ".$movimentacao_estoque_mestre->id.")",
                                            "origem"                => "AJU",
                                ...
                                echo " - quantidde não negativa em SP2";
                            }
                        }
                    }
                }
