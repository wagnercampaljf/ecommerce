            ...
            if($produto){
                ...
                if($response_produto_minas_gerais["httpCode"] < 300){
                    ...
                    if($response_criar_minas_gerais["httpCode"] == 200){
                        ...
                        echo " - Ajuste não feito Conta Minas Gerais";
                        print_r($response_criar_minas_gerais);
                    }
                }
                else{
                    
                    echo " - Produto não encontrado Minas Gerais";
                    ...
                    if($response_produto_conta_duplicada["httpCode"] == 200){
                        ...
                        if($response_criar_minas_gerais["httpCode"] == 200){
                            ...
                            echo " - Produto não cadastrado Conta Minas Gerais";
                            print_r($response_criar_minas_gerais);
                        }*/
                ...
                echo " - Produto não encontrado pelo GLOBAL";
            }
        }
    }
}
