...
//break;            
            ...
            foreach($response_omie["body"]["produtos"] as $k => $produto){
                ...
                //if($produto["cCodigo"] != "PA388008"){ continue; }
                ...
                if($pos === false || $pos != 0){
                    ...
                    if($produto_alteracao){
                        ...
                        if($produto_filial_fisica){
                            echo " - estoque encontrado (Física)";
                            $produto_filial_fisica->quantidade += $produto["nSaldo"];
                            if($produto_filial_fisica->save()){
                                echo " - Estoque atualizado";
                            }
                            else{
                                echo " - Estoque não atualizado";
		    ...
		    $produto_alteracao  = Produto::find()->andWhere(['=', 'id', $id])->one();
                    if($produto_alteracao){
                        ...
                        if($produto_filial_fisica){
                            ...
                            if($produto_filial_novo->save()){
                                echo " - Estoque criado (Física)";
                            }
                            else{
                                echo " - Estoque não criado (Física)";
                            }
                        }
                    }
                    else{
