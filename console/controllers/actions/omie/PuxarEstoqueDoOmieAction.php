    ...
    public function run()
    {
        ...
        //break;            
            ...
            foreach($response_omie["body"]["produtos"] as $k => $produto){
                ...
                //print_r($produto); die;
                echo "\nSP2: ".$k." - ".$produto["cCodigo"]." - Quantidade: ".$produto["nSaldo"];
        ...
        for($i = 1;$i <= $quantidade_paginas;$i++){
            ...
            foreach($response_omie["body"]["produtos"] as $k => $produto){
                ...
                //print_r($produto); die;
                echo "\nSP3: ".$k." - ".$produto["cCodigo"]." - Quantidade: ".$produto["nSaldo"];
        ...
        for($i = 1;$i <= $quantidade_paginas;$i++){
            ...
            foreach($response_omie["body"]["produtos"] as $k => $produto){
                ...
                //print_r($produto); die;
                echo "\nMG1: ".$k." - ".$produto["cCodigo"]." - Quantidade: ".$produto["nSaldo"];
        ...
        for($i = 1;$i <= $quantidade_paginas;$i++){
            ...
            foreach($response_omie["body"]["produtos"] as $k => $produto){
                ...
                //print_r($produto); die;
                echo "\nMG4: ".$k." - ".$produto["cCodigo"]." - Quantidade: ".$produto["nSaldo"];
        ...
        foreach($dados as $filial_id => $produtos_dados){
            ...
            foreach($produtos_dados as $codigo => $produto_quantidade){
                ...
                if($produto_alteracao){
                    echo " - produto encontrado - ".$produto_alteracao->id." - ".$filial_id;
                    ...
                    if($produto_filial){
                        echo " - estoque encontrado - ".$produto_filial->quantidade." - ".$produto_quantidade;
