...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/morelate_06_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_07_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_08_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_09_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_13_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_14_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_15_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_15_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_16_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_19_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_20_10_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_21_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_22_10_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_23_10_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_03_11_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_03_11_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_05_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_06_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_09_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_10_11_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_11_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_12_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_13_11_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_16_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_17_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_18_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_19_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_20_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_23_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_24_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_25_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_26_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_27_11_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_01_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_02_12_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_03_12_2020.csv", 'r');

        //file = fopen("/var/tmp/morelate_04_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_04_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_08_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_09_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_09_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_11_12_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_14_12_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_15_12_2020.csv", 'r');

        //  $file = fopen("/var/tmp/morelate_16_12_2020.csv", 'r');

        //   $file = fopen("/var/tmp/morelate_17_12_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_18_12_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_21_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_22_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_23_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_28_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_29_12_2020.csv", 'r');

        // $file = fopen("/var/tmp/morelate_30_12_2020.csv", 'r');

        //$file = fopen("/var/tmp/morelate_04_01_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_05_01_2021.csv", 'r');

        // $file = fopen("/var/tmp/morelate_06_01_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_07_01_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_08_01_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_11_01_2021.csv", 'r');

       // $file = fopen("/var/tmp/morelate_12_01_2021.csv", 'r');

       // $file = fopen("/var/tmp/morelate_13_01_2021.csv", 'r');
       ...
       // $file = fopen("/var/tmp/morelate_14_01_2021.csv", 'r');
        ...
        //$file = fopen("/var/tmp/morelate_20_01_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_20_01_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_22_01_2021.csv", 'r');

        $file = fopen("/var/tmp/morelate_28_01_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_28_01_2021.csv";
