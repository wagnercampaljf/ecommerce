...
class VannucciAtualizarPrecosAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_vannucci_preco_10-12-2020_precificado.csv")){
            unlink("/var/tmp/log_vannucci_preco_10-12-2020_precificadocsv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_vannucci_preco_10-12-2020_precificado.csv", "a");
