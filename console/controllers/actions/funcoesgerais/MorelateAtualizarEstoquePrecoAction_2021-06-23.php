...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
       ...
       // $file = fopen("/var/tmp/morelate_28_05_2021.csv", 'r');
        ...
        //$file = fopen("/var/tmp/morelate_09_06_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_10_06_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_14_06_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_16_06_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_17_06_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_18_06_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_21_06_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_22_06_2021.csv";
