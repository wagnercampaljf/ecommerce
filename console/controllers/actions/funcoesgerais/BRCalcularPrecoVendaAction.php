...
class BRCalcularPrecoVendaAction extends Action
{
    public function run(){
       ...
       // $arquivo_origem = '/var/tmp/br_preco_estoque_23-06-2021';

      //  $arquivo_origem = '/var/tmp/br_preco_estoque_25-06-2021';

        //$arquivo_origem = '/var/tmp/br_preco_estoque_01-06-2021';

       // $arquivo_origem = '/var/tmp/br_preco_estoque_07-07-2021';

       $arquivo_origem = '/var/tmp/br_preco_estoque_15-07-2021';
