...
class VendaCasadaAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/produtos_br-09-07-2021.csv", 'r');
        ...
        $log = "/var/tmp/log_produtos_br-09-07-2021.csv";
        if (file_exists($log)){
            unlink($log);
        }
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            if ($produto){
                ...
                echo  " - Produto encontrado - ".$produto->id;
