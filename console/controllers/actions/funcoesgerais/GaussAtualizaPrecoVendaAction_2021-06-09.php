...
class GaussAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_produtos_gauss_2021-06-01_precificado.csv")){
            unlink("/var/tmp/log_produtos_gauss_2021-06-01_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_produtos_gauss_2021-06-01_precificado.csv", "a");
