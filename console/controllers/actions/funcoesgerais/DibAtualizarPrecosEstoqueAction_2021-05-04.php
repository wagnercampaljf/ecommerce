...
class DibAtualizarPrecosEstoqueAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/dib_estoque_preco_30-12-2020_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_04-01-2021_precificado.csv", 'r');
        // $file = fopen("/var/tmp/dib_estoque_preco_18-01-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_09-02-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_24-02-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_08-03-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_15-03-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_22-03-2021_precificado.csv", 'r');
        ...
        // Vai logando
        $log = "/var/tmp/log_dib_estoque_preco_05-04-2021_precificado.csv";
