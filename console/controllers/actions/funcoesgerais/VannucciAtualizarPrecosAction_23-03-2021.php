...
class VannucciAtualizarPrecosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/vannuci_produtos_05-03-2021_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_vannuci_produtos_05-03-2021_precificado.csv")){
            unlink("/var/tmp/log_vannuci_produtos_05-03-2021_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_vannuci_produtos_05-03-2021_precificado.csv", "a");
