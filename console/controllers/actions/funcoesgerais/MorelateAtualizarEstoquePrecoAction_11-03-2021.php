...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/morelate_22_02_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_23_02_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_24_02_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_25_02_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_26_02_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_01_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_02_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_03_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_04_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_05_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_08_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_09_03_2021.csv", 'r');

        $file = fopen("/var/tmp/morelate_10_03_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_10_03_2021.csv";
