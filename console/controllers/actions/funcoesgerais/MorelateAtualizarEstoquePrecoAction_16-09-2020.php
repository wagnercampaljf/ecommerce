...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
        ...
        $log = "/var/tmp/log_morelate_16_09_2020.csv";
        if (file_exists($log)){
            unlink($log);
        }
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            if ($produto){
                ...
                if($produto_filial){
                    ...
                    if($produto->marca_produto_id == 392 || $produto->marca_produto_id == 244 || $produto->marca_produto_id == 258 || $produto->marca_produto_id == 222 || $produto->marca_produto_id == 600 || $produto->marca_produto_id == 775  ){
                        $preco_venda  = 1.25*$preco_venda;
                    }
