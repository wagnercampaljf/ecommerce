...
class BRAtualizarEstoquePrecosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/br_preco_estoque_04-01-2021_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_br_preco_estoque_04-01-2021_precificado.csv")){
            unlink("/var/tmp/log_br_preco_estoque_04-01-2021_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_br_preco_estoque_04-01-2021_precificado.csv", "a");
        //Escreve no log
