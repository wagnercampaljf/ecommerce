...
class GaussCalcularPrecoVendaAction extends Action
{
    public function run(){
        ...
        $faixas_lampadas_unidade = [
            ...
            4 => array(3 , 3.99 , 12, true),
            5 => array(4 , 4.99 , 12, true),
        ...
        $LinhasArray = Array();
        //$arquivo_origem = '/var/tmp/gauss_preco_estoque_22-10-2020';

        $arquivo_origem = '/var/tmp/gauss_preco_estoque_26-11-2020';
