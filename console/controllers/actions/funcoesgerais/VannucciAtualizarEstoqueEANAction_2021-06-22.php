...
class VannucciAtualizarEstoqueEANAction extends Action
{
    public function run(){
      ...
      //$file = fopen("/var/tmp/vannucci_estoque_06-04-2021.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_vannucci_estoque_01-06-2021.csv")){
            unlink("/var/tmp/log_vannucci_estoque_01-06-2021.csv");
        }
        
        $arquivo_log = fopen("/var/tmp/log_vannucci_estoque_01-06-2021.csv", "a");
