...
class ParanaAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/produtos_07_10-2020.csv", 'r');
       // $file = fopen("/var/tmp/produtos_parana-12-03-2021.csv", 'r');

        $file = fopen("/var/tmp/produtos_filialM-07-05-2021-nova.csv", 'r');
        ...
        $log = "/var/tmp/log_produtos_filialM-07-05-2021-nova.csv";
        if (file_exists($log)){
            unlink($log);
        }
