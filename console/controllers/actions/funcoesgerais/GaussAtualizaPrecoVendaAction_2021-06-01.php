...
class GaussAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_gauss_preco_estoque_11-05-2021_precificado.csv")){
            unlink("/var/tmp/log_gauss_preco_estoque_11-05-2021_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_gauss_preco_estoque_11-05-2021_precificado.csv", "a");
