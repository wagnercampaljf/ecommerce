...
class MorelateAtualizarProdutosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/pellegrino_morelate_nome_acima_150_SUBIR_2.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_pellegrino_morelate_nome_acima_150_SUBIR_2.csv")){
            unlink("/var/tmp/log_pellegrino_morelate_nome_acima_150_SUBIR_2.csv");
        }
        $arquivo_log = fopen("/var/tmp/log_pellegrino_morelate_nome_acima_150_SUBIR_2.csv", "a");
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            if ($produto){
                ...
                $nome_limpo = substr($linhaArray[1], 0, 150);
                
                $produto->nome              = $nome_limpo;
                $produto->aplicacao         = $linhaArray[2];
