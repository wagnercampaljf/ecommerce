...
class AmazonGerarPlanilhaDadosCompletaAction extends Action
{
    public function run(){
        ...
        $arquivo = fopen("/var/tmp/produtos_lng_13-01-2020.csv", "a");
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            if($produto_filial){
                ...
                if($produto_filial->filial_id == 60 ){
                    ...
                    fwrite($arquivo, "\n".$produto_filial->id.";".$preco.";".$min_preco.";".$max_preco.";".$produto_filial->quantidade.";".$sem_imagem.";");
