...
class BRAtualizarEstoquePrecosAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/br_preco_estoque_25-03-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_29-03-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_01-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_07-04-2021_precificado.csv", 'r');
       // $file = fopen("/var/tmp/br_preco_estoque_08-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_12-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_16-04-2021_precificado.csv", 'r');
       // $file = fopen("/var/tmp/br_preco_estoque_20-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_26-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_07-05-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_11-05-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_19-05-2021_precificado.csv", 'r');
     //   $file = fopen("/var/tmp/br_preco_estoque_25-05-2021_precificado.csv", 'r');
        // $file = fopen("/var/tmp/br_preco_estoque_01-06-2021_precificado.csv", 'r');
      //  $file = fopen("/var/tmp/br_preco_estoque_09-06-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_15-06-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_23-06-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/br_preco_estoque_01-06-2021_precificado.csv", 'r');

        $file = fopen("/var/tmp/br_preco_estoque_07-07-2021_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_br_preco_estoque_07-07-2021_precificado.csv")){
            unlink("/var/tmp/log_br_preco_estoque_07-07-2021_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_br_preco_estoque_07-07-2021_precificado.csv", "a");
        //Escreve no log
        ...
        foreach ($LinhasArray as $i => &$linhaArray){ //Looper que vai percorrer o array com as imformações de preços a subir
            ...
            $produto = Produto::find()  ->andWhere(['=','codigo_fabricante', $linhaArray[15]])
            ...
            if ($produto){ //Se encontrar o produto, processa o preço
                ...
                if ($produtoFilial) {//Se encontrar estoque, processa
                    ...
                    if($linhaArray[15]== '004760.B' && $linhaArray[15]== '509371.B' && $linhaArray[15]=='509917.B'){
                        $quantidade = 0;
                    ...
                    /*if ($produtoFilial->quantidade == $quantidade){
        ...
        fwrite($arquivo_log, "\n\n\n".'"Codigo_global";"codigo_fabricante";"quantidade";"status"');
          ...
          foreach($produtos_filial_br as $k => $produto_filial_br){
              ...
              if(!$produto_encontrado){
                  $produto_filial = ProdutoFilial::find() ->andWhere(['=','produto_id', $produto_filial_br->id])
