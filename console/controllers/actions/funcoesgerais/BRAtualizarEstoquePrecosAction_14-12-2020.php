...
class BRAtualizarEstoquePrecosAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_br_preco_estoque_1-12-2020_precificado.csv")){
            unlink("/var/tmp/log_br_preco_estoque_11-12-2020_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_br_preco_estoque_11-12-2020_precificado.csv", "a");
        //Escreve no log
