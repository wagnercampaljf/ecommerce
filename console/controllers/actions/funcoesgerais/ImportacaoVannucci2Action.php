...
class ImportacaoVannucci2Action extends Action
{
    public function run(){
        ...
        $LinhasArray = Array();
        $file = fopen('/var/tmp/vannucci_320_363.csv', 'r');
        ...
        if (file_exists("/var/tmp/log_importar_precos_vanucci_320.csv")){
            unlink("/var/tmp/log_importar_precos_vanucci_320.csv");
        }
        
        $arquivo_log = fopen("/var/tmp/log_importar_precos_vanucci_320.csv", "a");
        // Escreve no log
        ...
        foreach ($LinhasArray as $k => &$linhaArray ){
            ...
            if (!Subcategoria::findOne(['id'=>(int)$linhaArray[6]])){
                continue;
            }
            ...
            if ($codigo_global == null and $codigo_global == ""){
                ...
                $produto->nome              = $linhaArray[4];
                $produto->aplicacao         = $linhaArray[5];
                $produto->peso              = $linhaArray[7];
                $produto->altura            = $linhaArray[8];
                $produto->largura           = $linhaArray[9];
                $produto->profundidade      = $linhaArray[10];
                $produto->subcategoria_id   = $linhaArray[6];
                $produto->fabricante_id     = 91;
                $this->slugify($produto);
                if ($produto->save()){
                    fwrite($arquivo_log, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";".$linhaArray[12].";".$linhaArray[13].";".$linhaArray[14].";".$linhaArray[15].";".$linhaArray[16].";"."Produto CRIADO");
                } else{
                    fwrite($arquivo_log, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";".$linhaArray[12].";".$linhaArray[13].";".$linhaArray[14].";".$linhaArray[15].";".$linhaArray[16].";"."Produto NAO CRIADO\n");
                    continue;
                }
                ...
                $valorProdutoFilial->valor              = (float)str_replace(",",".",$linhaArray[16]);
                $valorProdutoFilial->valor_cnpj         = (float)str_replace(",",".",$linhaArray[16]);
