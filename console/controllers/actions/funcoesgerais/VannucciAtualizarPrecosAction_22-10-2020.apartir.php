...
class VannucciAtualizarPrecosAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_vannucci_21-10-2020_precificado.csv")){
            unlink("/var/tmp/log_vannucci_preco_15-10-2020_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_vannucci_preco_21-10-2020_precificado.csv", "a");
