...
class VannucciCalcularPrecoVendaAction extends Action
{
    public function run(){
        ...
        ];*/ //margem utilizada ate o dia 15-05-2020
        ...
        /*$faixas_venda =[
            ...
            49 => array(5000 , 100000 , 1.51, false),
            50 => array(100000 , 300000 , 1.50, false),
        ];*/ //margem utilizada ate o dia 25-11-2020
        ...
        ];*/ //margem utilizada ate o dia 09-12-2020
        ...
        //$arquivo_origem = '/var/tmp/vannucci_12-11-2020';
        //$arquivo_origem = '/var/tmp/vannucci_preco_12-12-2020';


        $arquivo_origem = '/var/tmp/vannucci_preco_14-12-2020';
