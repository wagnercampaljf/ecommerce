...
class LusarCalcularPrecoVendaAction extends Action
{
    public function run(){
        ...
        $arquivo_origem = '/var/tmp/lusar_28-03-202_criar';
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            if ($i <= 1){
                ...
                fwrite($arquivo_destino, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";Preço Venda;novo_codigo_fabricante\n");

                continue;
            }

            $preco_compra   = (float) $linhaArray[9];
            ...
            foreach ($faixas as $k => $faixa) {
                if($preco_compra >= $faixa[0] && $preco_compra <= $faixa[1]){
                    ...
                    fwrite($arquivo_destino, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";".$preco_venda.";".$novo_codigo_fabricante."\n");
   ...
   /* public function existe_produto_caixa($linha, $arquivo_destino){
        ...
        $produto = Produto::find()  ->andWhere(["=","codigo_fabricante","CX.".$linha[1]])
                                    ->andWhere(["=","fabricante_id",44])
                                    ->one();

        if($produto){

            $produto_sem_caixa  = Produto::find()   ->andWhere(["=","codigo_fabricante",$linha[1]])
                                                    ->andWhere(["=","fabricante_id",44])
                                                    ->one();
		    ...
		    echo " - ".$preco_venda." - "."CX.".$linha[1].".B";
                    fwrite($arquivo_destino, $linha[0].";".$linha[1].";".$linha[2].";".$linha[3].";".$linha[4].";".$linha[5].";".$linha[6].";".$linha[7].";".$linha[8].";".$linha[9].";".$linha[10].";".$linha[11].";".$preco_venda.";"."CX.".$linha[1].".B\n");
