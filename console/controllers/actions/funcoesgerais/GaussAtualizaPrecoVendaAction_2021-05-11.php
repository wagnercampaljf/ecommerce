...
class GaussAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/gauss_preco_estoque_26-11-2020_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_gauss_preco_estoque_26-11-2020_precificado.csv")){
            unlink("/var/tmp/log_gauss_preco_estoque_26-11-2020_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_gauss_preco_estoque_26-11-2020_precificado.csv", "a");
