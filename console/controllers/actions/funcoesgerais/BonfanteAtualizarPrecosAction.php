...
class BonfanteAtualizarPrecosAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/bonfante_estoque_preco_importados_05-07-2021_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_bonfante_estoque_preco_importados_09-07-2021_precificado.csv")){
            unlink("/var/tmp/log_bonfante_estoque_preco_importados_09-07-2021_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_bonfante_estoque_preco_importados_09-07-2021_precificado.csv", "a");
