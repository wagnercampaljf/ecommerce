...
class VerificacaoVannucciMarianaAction extends Action
{
    public function run(){
        ...
        fwrite($arquivo_log, "Código Item;NCM;Código Original;NOME;PESO;ALT;LARG;PROF;CÓD GLO;CÓD SIM;NCM;CÓD FABRIC;FABRIC;IDSUB;SUBCAT;SUBMELI_ID;SUBMELI_NOME;APLIC;APLIC COMP;DESC;MULT;Valor;Valor Compra;Valor Venda;STATUS;VERIFICAÇÃO\n");
