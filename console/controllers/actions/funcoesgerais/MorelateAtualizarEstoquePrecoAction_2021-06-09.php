...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
       ...
       // $file = fopen("/var/tmp/morelate_12_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_13_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_14_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_17_05_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_18_05_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_19_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_20_05_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_21_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_24_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_25_05_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_26_05_2021.csv", 'r');
        // $file = fopen("/var/tmp/morelate_27_05_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_28_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_31_05_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_01_06_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_02_06_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_07_06_2021.csv", 'r');

        $file = fopen("/var/tmp/morelate_08_06_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_08_06_2021.csv";
