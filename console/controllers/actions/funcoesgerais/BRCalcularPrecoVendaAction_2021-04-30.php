...
class BRCalcularPrecoVendaAction extends Action
{
    public function run(){
        ...
        //$arquivo_origem = '/var/tmp/br_preco_estoque_25-03-2021';

        //$arquivo_origem = '/var/tmp/br_preco_estoque_29-03-2021';

       // $arquivo_origem = '/var/tmp/br_preco_estoque_01-04-2021';

       // $arquivo_origem = '/var/tmp/br_preco_estoque_07-04-2021';

        //$arquivo_origem = '/var/tmp/br_preco_estoque_08-04-2021';

        //$arquivo_origem = '/var/tmp/br_preco_estoque_12-04-2021';

        //$arquivo_origem = '/var/tmp/br_preco_estoque_16-04-2021';

       // $arquivo_origem = '/var/tmp/br_preco_estoque_20-04-2021';

        $arquivo_origem = '/var/tmp/br_preco_estoque_26-04-2021';
