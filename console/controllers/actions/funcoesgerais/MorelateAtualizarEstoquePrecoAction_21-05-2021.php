...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
       ...
       // $file = fopen("/var/tmp/morelate_05_05_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_06_05_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_07_05_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_10_05_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_11_05_2021.csv", 'r');
       ...
       // $file = fopen("/var/tmp/morelate_19_05_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_17_05_2021.csv";
