...
class LNGAtualizarMultiplicadorAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/lng_multiplicador_10-12-2020.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_lng_multiplicador_10-12-2020..csv")){
            unlink("/var/tmp/log_lng_multiplicador_10-12-2020..csv");
        }
        $arquivo_log = fopen("/var/tmp/log_lng_multiplicador_10-12-2020.csv", "a");
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            fwrite($arquivo_log, "\n".'"'.$linhaArray[0].'";"'.$linhaArray[1].'";"'.$linhaArray[2].'";"'.$linhaArray[3].'";"'.$linhaArray[4].'"');
            ...
            echo "\n".$i." - ".$linhaArray[1]." - ".$linhaArray[2]." - ".$linhaArray[4];
            
            //$codigo_fabricante = "L".str_replace("-","",$linhaArray[2]);

            $codigo_fabricante = $linhaArray[2];
            ...
            if ($produto_filial){
                ...
                $produto->multiplicador  = (int) $linhaArray[4];
