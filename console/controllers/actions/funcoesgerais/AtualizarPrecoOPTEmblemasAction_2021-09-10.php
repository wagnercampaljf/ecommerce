    ...
    public function run(){
        ...
        foreach ($produtos as $k => $produto){
            ...
            foreach($produtos_filials as $i => $produto_filial){
                ...
                $valor_produto_filial->valor                = 90;
                $valor_produto_filial->valor_cnpj           = 90;
