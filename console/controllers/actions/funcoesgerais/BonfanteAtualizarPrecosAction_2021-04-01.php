...
class BonfanteAtualizarPrecosAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_bonfante_estoque_preco_importados_01-03-2021_precificado.csv")){
            unlink("/var/tmp/log_bonfante_estoque_preco_importados_01-03-2021_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_bonfante_estoque_preco_importados_01-03-2021_precificado.csv", "a");
