...
class EmblemasAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/produtos_marca_opt-emblemas-23-03-2021.csv", 'r');
        ...
        $log = "/var/tmp/log_produtos_marca_opt-emblemas-23-03-2021.csv";
        if (file_exists($log)){
            unlink($log);
        }
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            if ($produto){
                ...
                if ($linhaArray[6]==55){
                    ...
                    $preco_venda =60;
                }elseif ($linhaArray[6]==15 || $linhaArray[6]==20){
                    $preco_venda =15;
                }
                ...
                if($produto_filial){
                    ...
                    $produto_filial->quantidade = (int) $linhaArray[8];
