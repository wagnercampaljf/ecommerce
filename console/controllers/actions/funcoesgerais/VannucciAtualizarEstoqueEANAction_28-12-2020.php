...
class VannucciAtualizarEstoqueEANAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_vannucci_estoque_10-12-2020.csv")){
            unlink("/var/tmp/log_vannucci_estoque_10-12-2020.csv");
        }
        
        $arquivo_log = fopen("/var/tmp/log_vannucci_estoque_10-12-2020.csv", "a");
