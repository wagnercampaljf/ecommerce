...
class SorocardAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/produtos_sorocaba-30-12-2020.csv", 'r');
        ...
        $log = "/var/tmp/log_produtos_sorocaba-30-12-2020.csv";
        if (file_exists($log)){
            unlink($log);
        }
