...
class ForrosCriarProdutosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/produtos_subir_2021-06-30.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_produtos_subir_2021-06-30.csv")){
            unlink("/var/tmp/log_produtos_subir_2021-06-30.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_produtos_subir_2021-06-30.csv", "a");
        //Escreve no log
