...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/morelate_06_04_2021.csv", 'r');

       // $file = fopen("/var/tmp/morelate_07_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_08_04_2021.csv", 'r');

       // $file = fopen("/var/tmp/morelate_09_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_12_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_14_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_15_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_16_04_2021.csv", 'r');

       // $file = fopen("/var/tmp/morelate_19_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_20_04_2021.csv", 'r');

      //  $file = fopen("/var/tmp/morelate_22_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_23_04_2021.csv", 'r');

       //$file = fopen("/var/tmp/morelate_26_04_2021.csv", 'r');

       // $file = fopen("/var/tmp/morelate_27_04_2021.csv", 'r');

        $file = fopen("/var/tmp/morelate_28_04_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_30_03_2021.csv";
