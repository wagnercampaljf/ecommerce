...
class VannucciAtualizarEstoqueEANAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/vannucci_estoque_11-02-2020.csv", 'r');
        //$file = fopen("/var/tmp/vannucci_estoque_14-04-2020.csv", 'r');
        //$file = fopen("/var/tmp/vannucci_estoque_21-05-2020.csv", 'r');
        ...
        $file = fopen("/var/tmp/vannucci_estoque_10-11-2020.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_vannucci_estoque_10-11-2020.csv")){
            unlink("/var/tmp/log_vannucci_estoque_10-11-2020.csv");
        }
        
        $arquivo_log = fopen("/var/tmp/log_vannucci_estoque_07-10-2020.csv", "a");
