...
class SK3AtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/produtos_SK3-04-12-2020.csv", 'r');
        ...
        $log = "/var/tmp/log_produtos_SK3-04-12-2020.csv";
        if (file_exists($log)){
            unlink($log);
        }
