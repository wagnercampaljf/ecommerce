...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/morelate_12_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_15_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_16_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_17_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_18_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_19_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_22_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_23_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_24_03_2021.csv", 'r');

       //$file = fopen("/var/tmp/morelate_25_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_26_03_2021.csv", 'r');

        $file = fopen("/var/tmp/morelate_29_03_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_29_03_2021.csv";
