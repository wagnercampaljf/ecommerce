...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/morelate_29_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_30_04_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_03_05_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_04_05_2021.csv", 'r');
       ...
       // $file = fopen("/var/tmp/morelate_05_05_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_03_05_2021.csv";
