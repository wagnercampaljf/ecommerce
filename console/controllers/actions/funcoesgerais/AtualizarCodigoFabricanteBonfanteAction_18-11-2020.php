...
class AtualizarCodigoFabricanteBonfanteAction extends Action
{
    public function run(){
        ...
        $LinhasArray = Array();
        $file = fopen('/var/tmp/bonfante_11-11-2020.csv', 'r');
        ...
        if (file_exists("/var/tmp/log_bonfante_11-11-2020.csv")){
            unlink("/var/tmp/log_bonfante_11-11-2020.csv");
        }

        $arquivo_log = fopen("/var/tmp/log_bonfante_11-11-2020.csv", "a");
        // Escreve no log
