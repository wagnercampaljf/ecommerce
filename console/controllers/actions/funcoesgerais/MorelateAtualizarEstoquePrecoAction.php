    ...
    public function run(){
      ...
      //$file = fopen("/var/tmp/morelate_02_07_2021.csv", 'r');
       ...
       // $file = fopen("/var/tmp/morelate_08_07_2021.csv", 'r');
        ...
        //$file = fopen("/var/tmp/morelate_13_07_2021.csv", 'r');
        //$file = fopen("/var/tmp/morelate_14_07_2021.csv", 'r');
       // $file = fopen("/var/tmp/morelate_15_07_2021.csv", 'r');

       $file = fopen("/var/tmp/morelate_16_07_2021.csv", 'r');
        ...
        $log = "/var/tmp/log_morelate_16_07_2021.csv";
