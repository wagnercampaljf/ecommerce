...
class BFAtualizaPrecoVendaAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/produtos_bf-30-12-2020.csv", 'r');
        //$file = fopen("/var/tmp/produtos_bf-30-12-2020.csv", 'r');



        $file = fopen("/var/tmp/produtos_BF_12-02-2021.csv", 'r');
        ...
        $log = "/var/tmp/log_produtos_BF_12-02-2021.csv";
        if (file_exists($log)){
            unlink($log);
        }
