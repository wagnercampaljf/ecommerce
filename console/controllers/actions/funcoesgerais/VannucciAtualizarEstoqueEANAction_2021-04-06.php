...
class VannucciAtualizarEstoqueEANAction extends Action
{
    public function run(){
        ...
        if (file_exists("/var/tmp/log_vannucci_estoque_09-02-2021.csv")){
            unlink("/var/tmp/log_vannucci_estoque_09-02-2021.csv");
        }
        
        $arquivo_log = fopen("/var/tmp/log_vannucci_estoque_09-02-2021.csv", "a");
