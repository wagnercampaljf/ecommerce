...
class DibAtualizarPrecosEstoqueAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/dib_estoque_preco_05-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_12-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_19-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_26-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_03-04-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_17-05-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_24-05-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_31-05-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_07-06-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_14-06-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_16-06-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_28-06-2021_precificado.csv", 'r');
        //$file = fopen("/var/tmp/dib_estoque_preco_02-07-2021_precificado.csv", 'r');

        $file = fopen("/var/tmp/dib_estoque_preco_07-07-2021_precificado.csv", 'r');
        ...
        // Vai logando
        $log = "/var/tmp/log_dib_estoque_preco_07-07-2021_precificado.csv";
