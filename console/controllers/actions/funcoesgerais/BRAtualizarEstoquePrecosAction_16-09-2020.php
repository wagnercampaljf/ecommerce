...
class BRAtualizarEstoquePrecosAction extends Action
{
	...
	//$file = fopen("/var/tmp/br_preco_22-06-2020_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_br_preco_03-08-2020_precificado.csv")){
            unlink("/var/tmp/log_br_preco_03-08-2020_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_br_preco_estoque_08-09-2020_precificado.csv", "a");
        //Escreve no log
