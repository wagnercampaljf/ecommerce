...
class ImportacaoPrecosVanucciAction extends Action
{
    public function run(){
        ...
        $LinhasArray = Array();
        $file = fopen('/var/tmp/ListaVannucci250320.csv', 'r');
        ...
        foreach ($LinhasArray as $k => &$linhaArray ){
            ...
            if ($codigo_global == null and $codigo_global == ""){
                ...
                $produto->profundidade      = $linhaArray[6];
                $produto->subcategoria_id   = $linhaArray[10];
                $produto->fabricante_id     = 91;
                //var_dump($produto->save()); die;
                if ($produto->save()){
                    fwrite($arquivo_log, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";".$linhaArray[12].";"."Produto CRIADO");
                } else{
                    fwrite($arquivo_log, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";".$linhaArray[12].";"."Produto NAO CRIADO\n");
                    continue;
                }
