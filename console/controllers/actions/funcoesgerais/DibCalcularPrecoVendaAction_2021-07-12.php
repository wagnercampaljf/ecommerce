...
class DibCalcularPrecoVendaAction extends Action
{
    public function run(){
        ...
        //$arquivo_origem = '/var/tmp/dib_estoque_preco_24-05-2021';

       // $arquivo_origem = '/var/tmp/dib_estoque_preco_31-05-2021';

        //$arquivo_origem = '/var/tmp/dib_estoque_preco_07-06-2021';

       // $arquivo_origem = '/var/tmp/dib_estoque_preco_14-06-2021';

        //$arquivo_origem = '/var/tmp/dib_estoque_preco_16-06-2021';

       // $arquivo_origem = '/var/tmp/dib_estoque_preco_21-06-2021';

      //  $arquivo_origem = '/var/tmp/dib_estoque_preco_28-06-2021';

       // $arquivo_origem = '/var/tmp/dib_estoque_preco_02-07-2021';

       // $arquivo_origem = '/var/tmp/dib_estoque_preco_05-07-2021';

        $arquivo_origem = '/var/tmp/dib_estoque_preco_07-07-2021';
