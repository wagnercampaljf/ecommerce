...
class BonfanteCalcularPrecoVendaAction extends Action
{
    public function run(){
        ...
        //$arquivo_origem = '/var/tmp/bonfante_05-11-2020';
        //$arquivo_origem = '/var/tmp/planilha_bonfante_codigos';
       // $arquivo_origem = '/var/tmp/bonfante_06-01-2021-importados';
        //$file = fopen("/var/tmp/bonfante_14-01-2021_precificado.csv", 'r');
        //$arquivo_origem = '/var/tmp/bonfante_01-02-2021';

        $arquivo_origem = '/var/tmp/bonfante_estoque_preco_01-02-2021';
