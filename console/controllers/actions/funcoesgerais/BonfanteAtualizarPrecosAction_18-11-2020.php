...
class BonfanteAtualizarPrecosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/planilha_bonfante_codigos_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_planilha_bonfante_codigos_precificado.csv")){
            unlink("/var/tmp/log_planilha_bonfante_codigos_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_planilha_bonfante_codigos_precificado.csv", "a");
