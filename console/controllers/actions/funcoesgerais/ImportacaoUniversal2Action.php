...
class ImportacaoUniversal2Action extends Action
{
    public function run(){
        ...
        $LinhasArray = Array();
        $file = fopen('/var/tmp/cadastro_produtos_universal_02.csv', 'r');
        ...
        foreach ($LinhasArray as $k => &$linhaArray ){
            ...
            $produto->codigo_montadora  = $linhaArray[11];
            $produto->codigo_global     = $linhaArray[17];
            $produto->nome              = $linhaArray[2];
            $produto->aplicacao         = $linhaArray[4];
            $produto->peso              = str_replace(',','.',$linhaArray[12]);
            $produto->altura            = str_replace(',','.',$linhaArray[13]);
            $produto->largura           = str_replace(',','.',$linhaArray[15]);
            $produto->profundidade      = str_replace(',','.',$linhaArray[14]);
            $produto->codigo_barras     = $linhaArray[16];
            $produto->subcategoria_id   = $linhaArray[19]; 
            $produto->fabricante_id     = 109;
            //print_r($produto);
            if ($produto->save()){
                echo "Produto CRIADO\n";
                fwrite($arquivo_log, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";".$linhaArray[12].";".$linhaArray[13].";".$linhaArray[14].";".$linhaArray[15].";".$linhaArray[16].";".$linhaArray[17].";".$linhaArray[18].";".$linhaArray[19].";".$linhaArray[20].";".$linhaArray[21].";".$linhaArray[22].";".$linhaArray[23].";".$linhaArray[24].";".$linhaArray[25].";".$linhaArray[26].";".$linhaArray[27].";".$linhaArray[28].";"."Produto CRIADO");
            } else{
                fwrite($arquivo_log, $linhaArray[0].";".$linhaArray[1].";".$linhaArray[2].";".$linhaArray[3].";".$linhaArray[4].";".$linhaArray[5].";".$linhaArray[6].";".$linhaArray[7].";".$linhaArray[8].";".$linhaArray[9].";".$linhaArray[10].";".$linhaArray[11].";".$linhaArray[12].";".$linhaArray[13].";".$linhaArray[14].";".$linhaArray[15].";".$linhaArray[16].";".$linhaArray[17].";".$linhaArray[18].";".$linhaArray[19].";".$linhaArray[20].";".$linhaArray[21].";".$linhaArray[22].";".$linhaArray[23].";".$linhaArray[24].";".$linhaArray[25].";".$linhaArray[26].";".$linhaArray[27].";".$linhaArray[28].";"."Produto NAO CRIADO\n");
            ...
            $valorProdutoFilial->valor              = (float)str_replace(",",".",$linhaArray[29]);
            $valorProdutoFilial->valor_cnpj         = (float)str_replace(",",".",$linhaArray[29]);
            ...
            $caminhoImagemComLogo   = "/var/tmp/Universal/com_logo/".$produto->codigo_fabricante.".jpg";
            $caminhoImagemSemLogo   = "/var/tmp/Universal/sem_logo/".$produto->codigo_fabricante.".jpg";
