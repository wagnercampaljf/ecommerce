...
class BonfanteAtualizarPrecosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/bonfante_06-01-2021-importados_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_bonfante_06-01-2021-importados_precificado.csv")){
            unlink("/var/tmp/log_bonfante_06-01-2021-importados_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_bonfante_06-01-2021-importados_precificado.csv", "a");
