...
class VannucciAtualizarPrecosAction extends Action
{
	...
	$file = fopen("/var/tmp/vannucci_15-05-2020_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_vannucci_15-05-2020_precificado.csv")){
            unlink("/var/tmp/log_vannucci_preco_15-05-2020_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_vannucci_preco_15-05-2020_precificado.csv", "a");
