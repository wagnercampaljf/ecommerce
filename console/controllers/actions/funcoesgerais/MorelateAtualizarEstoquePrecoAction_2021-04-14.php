...
class MorelateAtualizarEstoquePrecoAction extends Action
{
    public function run(){
        ...
        //$file = fopen("/var/tmp/morelate_30_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_31_03_2021.csv", 'r');

        //$file = fopen("/var/tmp/morelate_01_04_2021.csv", 'r');

       // $file = fopen("/var/tmp/morelate_05_04_2021.csv", 'r');
