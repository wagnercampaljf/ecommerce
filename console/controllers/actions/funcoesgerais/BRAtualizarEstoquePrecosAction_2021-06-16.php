    ...
    public function run(){
     ...
     //   $file = fopen("/var/tmp/br_preco_estoque_25-05-2021_precificado.csv", 'r');
      ...
      //  $file = fopen("/var/tmp/br_preco_estoque_09-06-2021_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_br_preco_estoque_15-06-2021_precificado.csv")){
            unlink("/var/tmp/log_br_preco_estoque_15-06-2021_precificado.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_br_preco_estoque_15-06-2021_precificado.csv", "a");
        //Escreve no log
