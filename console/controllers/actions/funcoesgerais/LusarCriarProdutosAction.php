...
class LusarCriarProdutosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/lusar_29-03-202_criar_precificado.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_lusar_29-03-202_criar_precificado.csv")){
            unlink("/var/tmp/log_lusar_29-03-202_criar_precificado.csv");
        }

        $arquivo_log = fopen("/var/tmp/log_lusar_29-03-202_criar_precificado.csv", "a");

        foreach ($LinhasArray as $i => &$linhaArray){

            fwrite($arquivo_log, "\n".'"'.$linhaArray[0].'";"'.$linhaArray[1].'";"'.$linhaArray[2].'";"'.$linhaArray[3].'";"'.$linhaArray[4].'";"'.$linhaArray[5].'";"'.$linhaArray[6].'";"'.$linhaArray[7].'";"'.$linhaArray[8].'";"'.$linhaArray[9].'";"'.$linhaArray[10].'";"'.$linhaArray[11].'";"'.$linhaArray[12].'";"'.$linhaArray[12].'";');
