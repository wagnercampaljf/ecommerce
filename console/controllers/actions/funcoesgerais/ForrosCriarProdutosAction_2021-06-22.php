...
class ForrosCriarProdutosAction extends Action
{
    public function run(){
        ...
        $file = fopen("/var/tmp/produtos_forros_kombi.csv", 'r');
        ...
        if (file_exists("/var/tmp/log_produtos_forros_kombi.csv")){
            unlink("/var/tmp/log_produtos_forros_kombi.csv");
        }

        //Abre o arquivo de log pra ir logando a função
        $arquivo_log = fopen("/var/tmp/log_produtos_forros_kombi.csv", "a");
        //Escreve no log
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
            ...
            echo "\n".$i." - ".$linhaArray[0]." - ".$linhaArray[2]." - ".$linhaArray[6]." - ".$linhaArray[7];
