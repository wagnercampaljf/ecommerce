...
class BonfanteCalcularPrecoVendaAction extends Action
{
    public function run(){
       ...
       // $arquivo_origem = '/var/tmp/bonfante_estoque_preco_01-04-2021.2';
        //$arquivo_origem = '/var/tmp/bonfante_estoque_preco_03-05-2021';

        //$arquivo_origem = '/var/tmp/bonfante_estoque_preco_importados_05-07-2021';

        $arquivo_origem = '/var/tmp/bonfante_estoque_preco_importados_09-07-2021';
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
          ...
          //$preco_compra   = $linhaArray[5]*0.97; // Produtos normais


            $preco_compra   = $linhaArray[5]; //Produtos importados com, acrescimos de 5% IPI
