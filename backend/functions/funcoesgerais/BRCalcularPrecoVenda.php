...
class BRCalcularPrecoVenda extends Action
{
    ...
    try {
        ...
        $destino_erro = '/var/tmp/'."log_erro_".date('Y-M-d_H:i:s')."_".$file_planilha ;
        // if (file_exists($destino)){
        //     unlink($destino);
        // }
        
        $arquivo_destino = fopen($destino, "a");
        $arquivo_log_erro = fopen($destino_erro, "a");
        ...
        foreach ($LinhasArray as $i => &$linhaArray){
          ...
          || !array_key_exists($parametros_array['coluna_estoque'], $linhaArray)){
            ...
            //     fwrite($arquivo_destino, $codigo_fabricante.";".$nome.";".$preco_compra.";".$estoque."; \n");
       ...
       $filial_nome='BR';
        ...
        $email_texto = 'Segue em anexo a Planilha de atualização de preço de venda';
        if($arquivo_destino) {
