...
class AmazonGerarPlanilhaDadosCompleta extends Action
{
    /*public function run($parametros,$file_planilha){
        ...
        $arquivo = fopen('/var/www/html/pecaagora/backend/web/uploads/'. $file_planilha, 'r');

        //$arquivo = fopen("/var/tmp/produtos_amazon_20-05-2021.csv", "a");
        ...
        $assunto = 'Planilha Amazon';

        $email_texto = 'Segue em anexo a Planilha de atualização Planilha Amazon';
    ...
    public function run($parametros,$file_planilha){
        ...
        echo "INÍCIO da rotina de geração da planilha com os dados para Amazon: \n\n";
        //$arquivo_PLANILHA = fopen('/var/www/html/pecaagora/backend/web/uploads/'. $file_planilha, 'r');
        //Gera planilha dos produtos já presentes na Amazon
        //$arquivo = fopen("/var/tmp/produtos_amazon_04-08-2021.csv", "a");
        ...
        $file = fopen("/var/www/html/backend/web/uploads/log_produtos_amazon_tab.csv", 'r'); //Abre arquivo com skus(produto_filial_id) que já estão cadastrados na Amazon, para subir
        ...
        $assunto = 'Planilha Amazon Atualização';

        $email_texto = 'Segue em anexo a Planilha de atualização de preço Amazon';
