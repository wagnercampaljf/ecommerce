    ...
    public function run($parametros, $file_planilha)
    {
        ...
        try {
            ...
            foreach ($LinhasArray as $i => &$linhaArray) {
                ...
                if ($i <= 0) {
                    fwrite($arquivo_destino,  $codigo_fabricante . ';' . $nome .  ';' . $linhaArray[$parametros_array['coluna_capas']] . ';' . $linhaArray[$parametros_array['coluna_estoque']] . ';' . $preco_compra . ";" . "\n");
                    continue;
                }
                ...
                foreach ($faixas as $k => $faixa) {
                    ...
                    if ($preco_compra >= $faixa[0] && $preco_compra <= $faixa[1]) {
                        ...
                        fwrite($arquivo_destino, $codigo_fabricante . ';' . $nome . ';' . $linhaArray[$parametros_array['coluna_capas']] . ';' . $linhaArray[$parametros_array['coluna_estoque']] . ';' . $preco_compra . ';' . $preco_venda . ";" . "\n");
