...
->orderBy(["id" => SORT_DESC]);
		...
		$query->orWhere(['like', 'upper(buyer_doc_number)', str_replace(" ","",$filtro)]);

		$query->orWhere(['like', 'upper(title)', $filtro]);
		$query->orWhere(['like', 'upper(codigo_fabricante)', $filtro]);

		$filtro_pa = str_replace("P", "", str_replace("A", "", $filtro));
...
/*        if(isset($params["PedidoMercadoLivreSearch"]['filtro_status_pedido_envido']) && isset($params["PedidoMercadoLivreSearch"]['filtro_status_pedido_nao_envido'])){

		var_dump($params["PedidoMercadoLivreSearch"]['filtro_status_pedido_envido']));
		var_dump($params["PedidoMercadoLivreSearch"]['filtro_status_pedido_envido']));

		if($params["PedidoMercadoLivreSearch"]['filtro_status_pedido_envido']) && $params["PedidoMercadoLivreSearch"]['filtro_status_pedido_nao_envido'])){
			
		}
		elseif($params["PedidoMercadoLivreSearch"]['filtro_status_pedido_envido']) && !$params["PedidoMercadoLivreSearch"]['filtro_status_pedido_nao_envido']))
        ...
        if(isset($params["PedidoMercadoLivreSearch"]['e_pedido_autorizado'])){
            ...
            $filtro_status_etiqueta_impressa = strtoupper($params["PedidoMercadoLivreSearch"]["e_pedido_autorizado"]);
