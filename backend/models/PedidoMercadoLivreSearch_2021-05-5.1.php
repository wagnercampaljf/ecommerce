...
class PedidoMercadoLivreSearch extends PedidoMercadoLivre
{
    ...
    public function filtro_status($params)
    {
        ...
        //$query = PedidoMercadoLivre::find()->joinWith(['pedidoMercadoLivreShipments', 'pedidoMercadoLivreShipments.pedidoMercadoLivre']);
        ...
        //FILTROS
        if(!is_null($params["PedidoMercadoLivreSearch"]["status"])){

            $filtro_status = strtoupper($params["PedidoMercadoLivreSearch"]["status"]);


            //$query->andFilterWhere(['like', 'upper(receiver_name)', $filtro_status]);

            $query->andFilterWhere(['like', 'pedido_mercado_livre.status', $this->status]);
    ...
    public function filtro_status_envio($params)
    {
        ...
        //FILTROS
        if(!is_null($params["PedidoMercadoLivreSearch"]["shipping_status"])){

            $filtro_status_envio = strtoupper($params["PedidoMercadoLivreSearch"]["shipping_status"]);


            //$query->andFilterWhere(['like', 'upper(receiver_name)', $filtro_status]);

            $query->andFilterWhere(['like', 'pedido_mercado_livre.shipping_status', $this->shipping_status]);
