...
use common\models\LogExpedicaoSearch;
...
class PedidosMercadoLivreExpedicaoController extends Controller
{
    ...
    public function actionIndex(
        ...
        $searchModelLog = new LogExpedicaoSearch();
...
//var_dump($administrador); die;
        ...
        return $this->render('index-expedicao', ["searchModel" => $searchModel, "dataProvider" => $dataProvider, "status" => $status, "contador" => $contador, 'searchModelLog' => $searchModelLog, 'dataProviderLog' => $dataProviderLog]);
    }
    ...
    public function actionLogExpedicao(){
        $searchModel = new LogExpedicaoSearch();
