...
//echo $data_inicial; die;
	...
	$retorno = "";
        ...
        //TRECHO PARA BUSCAR PELO CPF/CNPJ
		    ...
		    echo "(((("; print_r(ArrayHelper::getValue($post_ml, 'resource')); echo "))))";
			...
			continue;
			    ...
			    //if(isset($envio_dados['body']['receiver_address'])){continue;} 
                            ...
                            echo "(CLIENTE)<pre>"; print_r($body); echo "</pre>";
                            $response_omie = $meli->cria_cliente("api/v1/geral/clientes/?JSON=",$body);
                            echo "<br><br>"; var_dump($response_omie);
...
Skype: pecaagora";
            ...
            $pedido_mercado_livre->email_assunto = "{de} Pedido {codigo_fabricante} * {quantidade} - {nome} ({margem})". ' - '. $pedido_mercado_livre->pedido_meli_id;
            if($pedido_mercado_livre->user_id == "435343067"){
                $pedido_mercado_livre->email_assunto = "{de} Novo Pedido {codigo_fabricante} * {quantidade} - {nome} ({margem})". ' - '. $pedido_mercado_livre->pedido_meli_id;
            }
