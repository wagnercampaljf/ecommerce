                        ...
                        if($response_pedido["httpCode"] == 200){
                            ...
                            foreach($response_pedido["body"]["pedido_venda_produto"]["det"] as $j => $produto){
                                ...
                                if(("PA".$produto_filial->produto->id) == $produto["produto"]["codigo"]){
                                    ...
                                    $valor = $pedido_mercado_livre_produto->full_unit_price * $pedido_mercado_livre_produto->quantity - ($tarifas + $model->shipping_option_list_cost);
...
"det":[{"ide":{"codigo_item_integracao":"'.$produto["ide"]["codigo_item_integracao"].'"},"produto":{"codigo_produto_integracao":"'."PA".$produto_filial_alterado->produto->id.'",
"quantidade":'.$produto["produto"]["quantidade"].',"valor_unitario":'.$pedido_mercado_livre_produto->full_unit_price.',
...
"frete":{"outras_despesas":'.$tarifas.',"valor_frete":'.$model->shipping_option_list_cost.'}}]}';
                                        ...
                                        "param" => [
                                            ...
                                            "det"=> [
                                                ...
                                                "produto" => [
                                                    ...
                                                    "descricao"                 => "(".$produto_filial_alterado->produto->codigo_global.") ".$produto_filial_alterado->produto->nome,
                                                    "codigo"                    => "PA".$produto_filial_alterado->produto->id,
                                                    "codigo_produto"            => $produto_filial_alterado->produto->codigo_global,
                                                    "descricao"                 => "(".$produto_filial_alterado->produto->codigo_global.") ".$produto_filial_alterado->produto->nome
                                                ],
                                            ],
                                        ],
                                    ...
                                    $body["param"]["det"][0]["produto"]["valor_unitario"] = $valor;
                                    $body["param"]["frete"]["outras_despesas"] = $tarifas;
                                    $body["param"]["frete"]["valor_frete"] = $model->shipping_option_list_cost;*/
                                    //DESCONTOS
...
'                                    $body["param"]["det"][0]["produto"]["descricao"] = "(".$produto_filial_alterado->produto->codigo_global.") ".$produto_filial_alterado->produto->nome;*/
                                    ...
                                    //$response_omie = $omie->consulta("/api/v1/produtos/pedido/?JSON=",$body);
