        ...
        foreach ($acessoOmie as $key => $value) {
            ...
            if ($respPedido->body) {
                if (isset($respPedido->body["pedido_venda_produto"])) {
                    ...
                    $pedido = new Pedido();
                    $pedido->valor_total = $respPedido->body["pedido_venda_produto"]["total_pedido"]['valor_total_pedido'];
                    ...
                    foreach ($respPedido->body["pedido_venda_produto"]["det"] as $dadosProd) {
                        ...
                        $pedidoProdutoFilial->valor = $dadosProd['produto']['valor_total'] / $dadosProd['produto']['quantidade'];
                        $pedidoProdutoFilial->valor_cotacao = $dadosProd['produto']['valor_total'] / $dadosProd['produto']['quantidade'];
