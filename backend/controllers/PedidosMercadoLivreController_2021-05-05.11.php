...
class PedidosMercadoLivreController extends Controller
{
    ...
    public function actionIndex($filtro = null, $filtro_status = null, $filtro_status_envio = null)
    {

        return $this->render('index', [
            "filtro"                           => $filtro,
            'filtro_status'                    => $filtro_status,
            'filtro_status_envio'                    => $filtro_status_envio
...
"frete":{"outras_despesas":'.$tarifas.',"valor_frete":'.$frete.'}}]}';
    ...
    public function actionBaixarPedidoML($order = null)
    {
        ...
        $data_inicial = date('Y-m-d', strtotime("-3 days",strtotime(date('Y-m-d'))));
