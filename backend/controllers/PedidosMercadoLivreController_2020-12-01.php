        ...
        foreach($pedido_mercado_livre_produtos as $k => $pedido_mercado_livre_produto){
            ...
            foreach($pedido_mercado_livre_produto_produto_filials as $i => $pedido_mercado_livre_produto_produto_filial){
                ...
                if($pedido_mercado_livre_produto_produto_filial->quantidade > 0){
                    ...
                    $email_texto = str_replace("{quantidade}",$pedido_mercado_livre_produto_produto_filial->quantidade, $email_texto)." * ". $pedido_mercado_livre_produto_produto_filial->quantidade." ".$texto_unidades;
                    $email_texto = str_replace("{valor}",$pedido_mercado_livre_produto_produto_filial->valor, $email_texto)." * ". $pedido_mercado_livre_produto_produto_filial->quantidade." ".$texto_unidades;
                    ...
                    $assunto = "Pedido ".$codigo_fabricante." * ". $pedido_mercado_livre_produto_produto_filial->quantidade." ".$texto_unidades;
