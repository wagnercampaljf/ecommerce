...
class PlanilhaPrecoController extends \yii\web\Controller
{
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($post['PlanilhaPreco']['id'] ==97){
                ...
                if ($model->validate()) {
                    ...
                    $destino = 'uploads/' . $model->file_planilha->baseName ."_precificado.csv";
                    ...
                    foreach ($LinhasArray as $i => &$linhaArray){
                       ...
                       // print_r($novo_codigo_fabricante);die;
                        ...
                        $estoque = $linhaArray[$post['PlanilhaPreco']['coluna_estoque']];
                        ...
                        if (Yii::$app->request->isPost) {
                            ...
                            if ($model->file_planilha) {
                                ...
                                foreach ($model->file_planilha as $file) {
                                    $filename = $destino = 'uploads/' . $model->file_planilha->baseName ."_precificado.csv";
            ...
            elseif ($post['PlanilhaPreco']['id'] ==8){
    ...
    public function actionPlanilhaAtualizar()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($post['PlanilhaPreco']['id'] ==97){
                ...
                if ($model->validate()) {
                    ...
                    // Vai logando
                    $log = 'uploads/'.'log_' . $model->file_planilha->baseName ."_precificado.csv";
                    ...
                    foreach ($LinhasArray as $i => &$linhaArray){
                        ...
                        $codigo_fabricante = (!(strpos($linhaArray[$post['PlanilhaPreco']['coluna_codigo_fabricante']],"CX.") === false)) ? $linhaArray[$post['PlanilhaPreco']['coluna_codigo_fabricante']] : 'D'.$linhaArray[$post['PlanilhaPreco']['coluna_codigo_fabricante']];
                        ...
                        if ($produto){
                            ...
                            if ($produtoFilial) {
                                ...
                                //var_dump($produtoFilial);die;



                                $quantidade =$linhaArray[$post['PlanilhaPreco']['coluna_estoque']];
                                ...
                                if ($linhaArray[$post['PlanilhaPreco']['coluna_preco']]== 0){
                                ...
                                $preco_venda =$linhaArray[$post['PlanilhaPreco']['coluna_preco']];
                                ...
                                $valor_produto_filial->valor                = $linhaArray[$post['PlanilhaPreco']['coluna_preco']];

                                $valor_produto_filial->valor_cnpj           = $linhaArray[$post['PlanilhaPreco']['coluna_preco']];

                                $valor_produto_filial->valor_compra         = $linhaArray[$post['PlanilhaPreco']['coluna_preco_compra']];
                        ...
                        if (Yii::$app->request->isPost) {
                            ...
                            if ($model->file_planilha) {
                                $mail = Yii::$app->mailer->compose()
                                    ...
                                    ->setTextBody($email_texto);
                                foreach ($model->file_planilha as $file) {
                                    $filename = $log = 'uploads/'.'log_' . $model->file_planilha->baseName ."_precificado.csv";
                                    //$file->saveAs($filename);
                                    $mail->attach($filename);
                                }
                                $mail->send();
        ...
        return $this->render('planilha-atualizar', ['model' => $model]);
