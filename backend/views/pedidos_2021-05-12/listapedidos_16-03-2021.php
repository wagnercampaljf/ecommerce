                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row">
                                    ...
                                    <p>Data Prevista: <?=
                                        Yii::$app->formatter->asDate($model->data_prevista,
                                            'dd/MM/yyyy')
                                        ?></p>
                                     <p>Filial:  <?= $model->filial->nome; ?></p>
                                    <a target="_blank" href="">

                                        <h2>Nº <?= $model['id'] ?></span></b></h2>
                                    </a>
                            ...
                            <div class="col-sm-2">
                                <di>
                                    ...
                                    <p style="font-weight: bold; color: rgba(41,41,41,0.95); white-space: nowrap;overflow: hidden; text-overflow: ellipsis"><span><?= $model->comprador->empresa->nome; ?></span> </p><p style=" white-space: nowrap;overflow: hidden; text-overflow: ellipsis"><?= $model->comprador->empresa->nome; ?></p>
