                ...
                <div class="card__body">
                    <div class="card__content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <div class="dropdown">
                                    <button class="btn btn-default dropdown-toggle" style="background-color: rgba(0,0,0,0); border-color: rgba(0,0,0,0)" data-toggle="dropdown"><img src="https://img.icons8.com/material/24/000000/menu-2--v1.png"/></button>
                                    <ul class="dropdown-menu">
                                        <li><a style="color: black" href=<?=Url::to(['/pedidos/mercado-livre-view', 'id' => $model['id']])?>> Ver detalhes</a></li>
                                        <li><a href= <?=Url::to(['/pedidos/mercado-livre-view', 'id' => $model['id']])?> > Adicionar comentario</a></li>
                                        <p>
