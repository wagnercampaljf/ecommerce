...
/* @var $model backend\models\FormularioCarantiaSearch */
...
<div class="formulario-garantia-search">
    ...
    <?php // echo $form->field($model, 'codigo_peca_seis_digitos') ?>
    ...
    <?php // echo $form->field($model, 'data_aplicacao') ?>
    ...
    <?php // echo $form->field($model, 'descricao_do_defeito_apresentado') ?>
