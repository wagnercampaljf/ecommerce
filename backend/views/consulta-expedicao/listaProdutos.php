            ...
            <div class="card__content">
                ...
                <div class="row">
                    ...
                    if ($logs_consulta_expedicao){
                        ...
                        echo '<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseExample'.$model->id.'" aria-expanded="false" aria-controls="collapseExample">';

                        echo ' Histórico de pesquisa';
                        echo '</button>';


                        echo ' </p>';

                        echo '<div class="collapse" id="collapseExample'.$model->id.'">';
