    ...
    <div class="portlet light">
        <div class="portlet-body">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#geral" data-toggle="tab">Peça Agora</a>
                </li>
                <li><a href="#mercado-livre-principal" data-toggle="tab">Mercado Livre(Principal)</a>
                </li>
            ...
            <div class="tab-content clearfix">
                ...
                <div class="tab-panel fade in active" id="mercado-livre-principal">
                    <?php  echo $this->render('index/_mercado-livre-principal', [ ]) ?>
                </div>
                <div class="tab-panel fade in active" id="b2w">
