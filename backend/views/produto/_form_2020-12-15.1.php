...
<div class="produto-form">
    ...
    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
	    ...
	    <div class=" col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <div id="mensagem">Alteraçoes salvas com sucesso!</div>

            <div class=" col-lg-3 col-md-3 col-sm-12 col-xs-12" onclick="msg()">
                <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Criar Produto') : Yii::t('app', 'Salvar Alterações'),['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-success', 'name'=>'submitButton', 'value'=>'expedicao']) ?>
    ...
    <div class="row">
        ...
        <div class="form-group pull-left">
            ...
            <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Criar Produto') : Yii::t('app', 'Salvar Alterações'),['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-success', 'name' => 'submit', 'value' => 'produto']) ?>
