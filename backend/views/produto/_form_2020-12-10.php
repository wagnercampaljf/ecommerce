...
<div class="produto-form">
    ...
    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
	    ...
	    <div class=" col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12 capitalize">
                <?= $form->field($model, 'localizacao')->textInput([ 'style'=>'text-transform: capitalize'])->hint("Galeria A, Corredor B, Prateleira 7.")->label("Localização") ?>
            </div>
