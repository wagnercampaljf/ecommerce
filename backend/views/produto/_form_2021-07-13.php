...
<div class="produto-form">
    ...
    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
            ...
            <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <?= $form->field($model, 'localizacao')->textInput(['id' => "localizacao", 'readOnly' => $model->e_localizacao_bloqueado, 'style' => 'text-transform: capitalize'])->label("Localização do Produto SP") ?>
            </div>
            <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12">
