...
<div class="produto-form">
    ...
    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
	    ...
	    <div class=" col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <?= $form->field($model, 'e_valor_bloqueado' )->checkbox(['id'=>"conferida",])  ?>
            </div>
        </div>
        <hr>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <?= $form->field($model, 'pis_cofins')->textInput(['maxlength' => true])->label("PIS/COFINS") ?>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <?= $form->field($model, 'produto_condicao_id')->widget(Select2::className(), [
                    'data' => ArrayHelper::map(
                        ProdutoCondicao::find()->orderBy(['nome' => SORT_ASC])->all(),
                        'id',
                        'nome'
                    ),
                    'options' => ['placeholder' => 'Selecione a condição do produto']
                ]) ?>
            </div>
        </div>
