    ...
    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <script>
            function desabilitar(selecionado) {
                document.getElementById('Peso').disabled = selecionado;
                document.getElementById('Altura').disabled = selecionado;
                document.getElementById('Largura').disabled = selecionado;
                document.getElementById('Profundidade').disabled = selecionado;;
        ...
        <div class="row">
            <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <?= $form->field($model, 'peso')->textInput(['id'=>"Peso",'disabled' => $model->e_medidas_conferidas])->hint("Separe as casa decimais com ponto.")->label("Peso (Kg)") ?>
            </div>
            <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <?= $form->field($model, 'altura')->textInput(['id'=>"Altura",'disabled' => $model->e_medidas_conferidas])->label("Altura (cm)") ?>
            </div>
            <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <?= $form->field($model, 'largura')->textInput(['id'=>"Largura",'disabled' => $model->e_medidas_conferidas])->label("Largura (cm)") ?>
            </div>
            <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <?= $form->field($model, 'profundidade')->textInput(['id'=>"Profundidade",'disabled' => $model->e_medidas_conferidas])->label("Profundidade (cm)") ?>
            </div>
        </div>
        <!-- script desativa campos -->
