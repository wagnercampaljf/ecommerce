    ...
    <div class="bs-wizard" style="border-bottom:0;">
        ...
        ?>
            ...
            <div class="col-xs-2 bs-wizard-step <?= $state ?>">
                ...
                ?>
                <a href='<?= Url::to(['mudar-status', 'id' => $model->id, 'status' => $key]) ?>' class="bs-wizard-dot mudarstatus">
                </a>
                ...
                <div class="card__body">
                    <div class="card__content">
                        <div class="card__description">
                            <p><?= $model->filial->nome ?>| <span style="font-weight: bold; color: rgba(41,41,41,0.95)"><?= $model->comprador->empresa->nome; ?></span> |
        ...
        <article class="card card_main" style="background-color: #f5f5f5">
            <div class="card__body">
                <div class="card__content">
                    ...
                    <?=
                    $form->field($model, 'compra_filial_id')->widget(Select2::className(), [
