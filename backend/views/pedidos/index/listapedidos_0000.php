                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <di>
                                    ...
                                    <p style=" white-space: nowrap;overflow: hidden; text-overflow: ellipsis"> Vendido para <?= $estado = Estado::findOne(Cidade::findOne(EnderecoEmpresa::findOne(['empresa_id' => Empresa::findOne(Comprador::findOne($model->comprador->id)->empresa_id)->id])->cidade_id)->estado_id)->sigla ?></p>
                                </di>
                            </div>
                            <div class="col-sm-1">
                                <a target="_blank" href="<?= Url::to(['/pedidos/view', 'id' => $model->id])
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-12" style="background-color: rgba(74,78,90,0.2); border-radius: 10px">
                                    <table class="table">
                                        ...
                                        <?php
                                        $model['valor_total'] = number_format($model['valor_total'], 2, '.', '');

                                        $valor_total= $model['valor_total'] + $model['valor_frete'];
