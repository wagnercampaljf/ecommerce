...
<?php $form = ActiveForm::begin(['action' => Url::to(['/pedidos/mercado-livre-update','id'=>$model['id']])]); ?>

<div class="container">

    <div class="row">
        <div class="col-sm-7">
            <h2> <?= ""//$produtos->count()//$produto['title'] ?></h2>
                            ...
                            <div class="card__description">
                                <?php foreach($produtos as $produto){ ?>
                                	...
                                	<?= Html::a(' <span class="glyphicon glyphicon-search" ></span > ',
                                        Url::to(['/pedidos/mercado-livre-produto', 'id' => $produto['id']]), [
            ...
            <div class="cards">
                <article class="card card_main" style="background-color: #f5f5f5">
                    <div class="card__body">
                        <div class="card__content">
                            <div>
                                <p style="font-weight: bold; color: rgba(41,41,41,0.95)"> Cálculo da Margem  </p>
                                <table class="table">
									
                                	<tr>
                                	    <th scope="row" style="font-size: 14px; border:none !important;">Valor venda</p></th>
                                	    <td style="border:none !important;"></td>
                                	    <td style="border:none !important;"></td>
                                	    <td style="border:none !important;"><?= Yii::$app->formatter->asCurrency($total) ?></td>
                                	</tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th scope="row" style="font-weight: bold; color: rgba(41,41,41,0.95)">Valor Líquido</p></th>
                                        <td></td>
                                        <td></td>
                                        <td style="font-weight: bold; color: rgba(41,41,41,0.95)"><?= Yii::$app->formatter->asCurrency($total - $valor_total_cotacao) ?></td>
                                    </tr>
        ...
        <article class="card card_main" style="background-color: #f5f5f5">
            <div class="card__body">
                <div class="card__content">
           			...
           			<?= $form->field($model, 'email_texto')->widget(Redactor::className()) ?>
...
<a class="btn btn-primary" href="<?= Url::to(['/pedidos/mercado-livre-autorizar', 'id'=>$model['id']]) ?>" role="button">Autorizar Pedido</a>
