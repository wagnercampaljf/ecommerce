            ...
            <article class="card card_main" style="background-color: #ffffff; border-radius: 10px">
                <div class="card__body">
                    <div class="card__content">
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    ...
                                    if ($model->e_pedido_autorizado==true){
                                        echo '<h2>'."Nº". $model->pedido_meli_id.'<b><span style="color:#008000;">'. ' (Autorizado)'. '</span></b></h2>';

                                    }elseif ($model->e_pedido_cancelado==true){
                                        echo '<h2>'."Nº". $model->pedido_meli_id. '<b><span style="color:#d90010;">' . ' (Cancelado)'. '</span></b></h2>';

                                    }else{
                                        echo '<h2>'."Nº". $model->pedido_meli_id. '</h2>';
                                    }
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                                <br><br><button onClick="window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/gerar-etiqueta', 'id' => $model['id']])?>'); document.location.reload(true);" type="button" class="btn btn-primary">Imprimir etiqueta</button>
                                <button onClick="window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/gerar-etiqueta', 'id' => $model['id']])?>')" type="button" class="btn btn-primary">Imprimir Nota Fiscal</button>
                            </div><br>
                        </div>
                    </div>
                </div>
