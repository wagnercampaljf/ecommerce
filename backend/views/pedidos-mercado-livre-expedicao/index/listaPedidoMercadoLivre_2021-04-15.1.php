                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="countries-form">
                            ...
                            <div class="form__group field">
                                <?= $form->field($model, 'observacao')->textInput(['maxlength' => 200,'class'=>'form__field','placeholder'=>'Name','id'=>'name',  "onfocusout" => "document.getElementById('"."botao_".$model->id."').click();"]) ?>
