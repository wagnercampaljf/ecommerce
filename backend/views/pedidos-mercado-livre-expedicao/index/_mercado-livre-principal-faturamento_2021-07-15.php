...
<?php
    ...
    $dataProvider = $searchModel->search(['PedidoMercadoLivreSearch'=> ['pedido_meli_id' => $filtro, 'e_xml_subido' => false, "e_pedido_autorizado" => true, "e_pedido_cancelado" => false, "filtro_status_pedido_enviado" => false, "filtro_status_pedido_nao_enviado" => true]]);
