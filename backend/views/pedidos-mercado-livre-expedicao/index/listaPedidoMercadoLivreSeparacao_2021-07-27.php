                    ...
                    <div class="card__content">
                        ...
                        <div class="row">
                        	<div class="col-sm-9">
                                ...
                                <div class="row">
                                	<div class="col-sm-3">
                                        <button onClick="window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/separacao-pre-nota', 'id' => $model['id']])?>')" type="button" class="btn btn-primary btn-block">Pré-Nota</button>
                                    </div>
                                    <br>
                                </div>
                            </div>
