	...
	<div class="container">
    	<form id="main-search" class="form form-inline sombra" role="form" action="<?= Url::to(['/pedidos-mercado-livre-expedicao']) ?>">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <input type="checkbox" class="switch" id="s_item1" name="filtro_status_pedido_enviado"  value="true" onchange="this.form.submit()">
                        <label for="scales">Pedido Enviado</label>

                        <input type="checkbox" class="switch" id="s_item2" name="filtro_status_pedido_nao_enviado"  value="true" onchange="this.form.submit()">
                        <label for="horns">Pedido Nâo enviado</label>
                    </div>
                    <div class="col-sm-4">
                        <input type="checkbox" class="switch" id="s_item3" name="filtro_status_etiqueta_impressa"  value="true" onchange="this.form.submit()">
                        <label for="scales">Etiqueta Impressa</label>

                        <input type="checkbox" class="switch" id="s_item4" name="filtro_status_etiqueta_nao_impressa"  value="true" onchange="this.form.submit()">
                        <label for="horns">Etiqueta Nâo Impressa</label>
                    </div>
                </div>
            </div>
