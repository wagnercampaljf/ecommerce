                    ...
                    <div class="card__content">
					    ...
					    echo "</span></b><h3>";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <button onClick="window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/gerar-etiqueta', 'id' => $model['id']])?>'); document.getElementById('substatus_<?=$model->id?>').innerHTML = '(Etiqueta Impressa)';" type="button" class="btn btn-primary btn-block">Imprimir etiqueta <?= ($model["quantidade_impressoes_etiqueta"] > 0) ? "(<span id='quantidade_impressao_etiqueta'>".$model["quantidade_impressoes_etiqueta"]."</span>)" : ""?> </button>
                                    </div>
                                    <div class="col-sm-3">
                                        <button onClick="window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/obter-nota-fiscal', 'id' => $model['id']])?>')" type="button" class="btn btn-primary btn-block">Imprimir Nota Fiscal <?= ($model["quantidade_impressoes_nota_fiscal"] > 0) ? "( <span id='quantidade_impressao_nota_fiscal'>".$model["quantidade_impressoes_nota_fiscal"]."</span>)" : ""?></button>
                                    </div><br>
                                    <div class="col-sm-3">
                                    </div><br>
                                </div>
