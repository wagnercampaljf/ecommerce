                    ...
                    <div class="card__content">
                        ...
                        <div class="row">
                        	<div class="col-sm-9">
                                ...
                                <div class="row">
                                	<div class="col-sm-12">
                                        <br><br><button onClick="window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/gerar-etiqueta', 'id' => $model['id']])?>')" type="button" class="btn btn-primary">Imprimir etiqueta</button>
                            ...
                            <div class="col-sm-3">
                                ...
                                if($pedido_mercado_livre_shipments){
                                    ...
                                    echo '<tr><td></td></tr>';
                                    echo '<tr>';
                                    echo '<td scope="row" style="font-size: 12px; border:none !important;">'. "Data entrega".'</p></td>';
                                    ...
                                    echo '</tr>';
                                    echo '<tr>';
                                    echo '<td scope="row" style="font-size: 12px; border:none !important;">'. "Data não entrega".'</p></td>';
                                    ...
                                    echo '</tr>';
                                    echo '<tr>';
                                    echo '<td scope="row" style="font-size: 12px; border:none !important;">'. "Data pronto para envio".'</p></td>';
                                    ...
                                    echo '</tr>';
                                    echo '<tr>';
                                    echo '<td scope="row" style="font-size: 12px; border:none !important;">'. "Data envio".'</p></td>';
                                    ...
                                    echo '</tr>';
                                    echo '<tr>';
                                    echo '<td scope="row" style="font-size: 12px; border:none !important;">'. "Data retorno".'</p></td>';
