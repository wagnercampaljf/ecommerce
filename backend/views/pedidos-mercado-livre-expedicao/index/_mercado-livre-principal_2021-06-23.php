            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="checkbox" class="switch" id="s_item1" name="filtro_status_cancelado"  value="true" onchange="this.form.submit()">
                        <label for="scales">Pedido Cancelado</label>

                        <input type="checkbox" class="switch" id="s_item2" name="filtro_status_cancelado"  value="false" onchange="this.form.submit()">
                        <label for="horns">Pedido não cancelado</label>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="checkbox" class="switch" id="s_item3" name="filtro_status_pedido_faturado"  value="true" onchange="this.form.submit()">
                        <label for="scales">Pedido Faturado</label>
                        <input type="checkbox" class="switch" id="s_item4" name="filtro_status_pedido_faturado"  value="false" onchange="this.form.submit()">
                        <label for="horns">Pedido não Faturado</label>



                    </div>
                    <div class="col-sm-4">
                        <input type="checkbox" class="switch" id="s_item5" name="filtro_status_pedido_envido"  value="true" onchange="this.form.submit()">
                        <label for="scales">Pedido Enviado</label>

                        <input type="checkbox" class="switch" id="s_item6" name="filtro_status_pedido_envido"  value="false" onchange="this.form.submit()">
                        <label for="horns">Pedido Nâo enviado</label>
                    </div>

                    <div class="col-sm-4">

                        <input type="checkbox" class="switch" id="s_item7" name="filtro_status_pedido_autorizado"  value="true" onchange="this.form.submit()">
                        <label for="scales">Pedido autorizado</label>

                        <input type="checkbox" class="switch" id="s_item8" name="filtro_status_pedido_autorizado"  value="false" onchange="this.form.submit()">
                        <label for="horns">Pedido Nâo autorizado</label>
...
}elseif ($filtro_status_pedido_autorizado== 'false'){

    echo "<br>". "<p style='font-size: 30px;color: #1b6d85'>" . "Pedido não Autorizado" ."</p><br>";

}elseif ($filtro_status_pedido_autorizado== 'true'){

    echo "<br>". "<p style='font-size: 30px;color: #1b6d85'>" . "Pedido Autorizado" ."</p><br>";
