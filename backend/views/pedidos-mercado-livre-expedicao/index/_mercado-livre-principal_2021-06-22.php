...
<form action="<?= Url::to(['/pedidos-mercado-livre-expedicao/' ]) ?>" >
    ...
    <button type="submit" name="filtro_status_pedido_autorizado" value = "true" class="btn btn-primary" >Pedido autorizado</button>
    <button type="submit" name="filtro_status_pedido_autorizado"  value = "false" class="btn btn-success">Pedido Nâo autorizado</button>
