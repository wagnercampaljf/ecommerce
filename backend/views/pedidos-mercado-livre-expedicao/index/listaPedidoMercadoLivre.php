                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                if ($model->user_id == 193724256) {
                                    ...
                                    if ($model->nota_fiscal_compra_id) {
                                        $nota_fiscal = NotaFiscal::findOne($model->nota_fiscal_compra_id)->numero_nf;
                                        echo '<h4 style="color: #1b6d85">' . "Nota Recebida - ($nota_fiscal)" . '</h4>';
                                    }
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            if ($pedido_mercado_livre_shipments) {
                                                echo '<h3><b><span id="substatus_' . $model->id . '" style="color:#d90010;">';
                                                $substatus = "(";
                                                ...
                                                echo '<h3><b><span style="color:#008000;">';
                                                $substatus = "(";
                                                ...
                                                switch ($pedido_mercado_livre_shipments->status) {
                                                    ...
                                                    case "pending":
                                                        ...
                                                        break;
                                                    case "ready_to_ship":
                                                        if ($pedido_mercado_livre_shipments->substatus == "dropped_off") {
                                                            $substatus .= "Já enviado";
                                                        } else {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-11">
                                        <di>
                                            <p style="font-weight: bold; color: rgba(41,41,41,0.95); white-space: nowrap;overflow: hidden; text-overflow: ellipsis"><span><?= $model['buyer_first_name'] ?> <?= $model['buyer_last_name'] ?></span> </p>
                                            <p style=" white-space: nowrap;overflow: hidden; text-overflow: ellipsis"><?= $model['buyer_nickname'] ?></p>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <button onClick="quantidade_etiqueta('quantidade_impressao_etiqueta_<?= $model["id"] ?>'); window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/gerar-etiqueta', 'id' => $model['id']]) ?>'); document.getElementById('substatus_<?= $model->id ?>').innerHTML = '(Etiqueta Impressa)';" type="button" class="btn btn-primary btn-block">Imprimir etiqueta <?= ($model["quantidade_impressoes_etiqueta"] > 0) ? "<span id='quantidade_impressao_etiqueta_" . $model["id"] . "'>(" . $model["quantidade_impressoes_etiqueta"] . ")</span>" : "<span id='quantidade_impressao_etiqueta_" . $model["id"] . "'></span>" ?> </button>
                                    </div>
                                    <div class="col-sm-3">
                                        <button onClick="quantidade_nota_fiscal('quantidade_impressao_nota_fiscal_<?= $model["id"] ?>'); window.open('<?= Url::to(['/pedidos-mercado-livre-expedicao/obter-nota-fiscal', 'id' => $model['id']]) ?>')" type="button" class="btn btn-primary btn-block">Imprimir Nota Fiscal <?= ($model["quantidade_impressoes_nota_fiscal"] > 0) ? "<span id='quantidade_impressao_nota_fiscal_" . $model["id"] . "'>(" . $model["quantidade_impressoes_nota_fiscal"] . ")</span>" : "<span id='quantidade_impressao_nota_fiscal_" . $model["id"] . "'></span>" ?></button>
                                    </div>
                                    <div class="col-sm-3">
                                        <?php
                                        if (!is_null($model->nota_fiscal_id)) {
                                            $nota_fiscal = NotaFiscal::find()->andWhere(["=", "id", $model->nota_fiscal_id])->one();
                                            if ($nota_fiscal) {
                                                echo "Número NF: " . $nota_fiscal->numero_nf.(!is_null($model->shipping_id) ? "<br>Etiqueta: " . $model->shipping_id : '');
                                            }
                                        }
                                        ?>
                                    </div><br>
