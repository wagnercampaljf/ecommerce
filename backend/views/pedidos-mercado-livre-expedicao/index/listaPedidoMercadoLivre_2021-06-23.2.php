                ...
                <div class="card__body">
                    <div class="card__content">
					    ...
					    echo "</span></b><h3>";
                                ...
                                <div class="row">
                                	<div class="col-sm-3">
										<a href="<?= Url::to(['/pedidos-mercado-livre-expedicao/enviar-pedido', 'id' => $model['id']])?>"> <button type="button" class="btn btn-primary btn-block">Enviar Pedido</button> </a>
                                    </div>
                                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="countries-form">
                            ...
                            <?php $form = ActiveForm::begin(['options' => ['data-pjax' => true ], 'action' => Url::to(['/pedidos-mercado-livre-expedicao/update-observacao','id'=>$model['id']])] ); ?>
                                <?= $form->field($model, 'observacao')->textarea(['maxlength' => 10000, "id"=>"observacao_".$model->id, "name"=>"observacao".$model->id]) ?>
