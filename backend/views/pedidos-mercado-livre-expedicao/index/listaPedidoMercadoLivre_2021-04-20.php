                    ...
                    <div class="col-sm-12">
                        ...
                        ?>
                            ...
                            <?php $form = ActiveForm::begin(['options' => ['data-pjax' => true ], 'action' => Url::to(['/pedidos-mercado-livre-expedicao/update-observacao','id'=>$model['id']])] ); ?>
                                <?= $form->field($model, 'observacao')->textarea(['maxlength' => 10000,  ]) ?>


                            <div class="form-group">

                                <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Alterar') : Yii::t('app', 'Salvar'), ['class' => $model->isNewRecord ? 'btn btn-success hidden' : 'btn btn-primary', ]) ?>
                            </div>
