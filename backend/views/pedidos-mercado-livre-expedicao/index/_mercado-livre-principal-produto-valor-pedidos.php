...
<div class="container">
    ...
    <div class="row">
        ...
        if($pedido_mercado_livre_produto_produto_filiais){
            ...
            echo '<tr>';
            echo '<th scope="row" style="font-size: 14px; border:none !important;">'."Valdsfdsor compra". ' </p></th>';
            echo '<td style="border:none !important;"></td>';
            echo '<td style="border:none !important;"></td>';
            echo '<td style="border:none !important;">'.Yii::$app->formatter->asCurrency($valor_total).'</td>';
            echo '</tr>';
        }else{
            $valor_total= 0;
        }
