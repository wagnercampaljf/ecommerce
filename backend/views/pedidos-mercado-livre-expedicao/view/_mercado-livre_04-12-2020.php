                            ...
                            <div>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><?= Yii::$app->formatter->asCurrency($valor_venda) ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        if($pedido_mercado_livre_produto_produto_filiais){
                                            ...
                                            echo '<tr>';
                                            echo'<th scope="row" style="font-size: 14px; border:none !important;">'."Valor compra". ' </p></th>';
                                            echo  '<td style="border:none !important;"></td>';
                                            echo '<td style="border:none !important;"></td>';
                                            echo '<td style="border:none !important;">'."R$ ". $valor_total .'</td>';
                                            echo '</tr>';
                                        }else{
                                            $valor_total= 0;
                                        }
                                        ...
                                        $valor_liquido= $valor_venda -  $valor_total
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none !important;"></td>
                                        <td style="border:none !important;"></td>
                                        <td style="font-weight: bold; border:none !important; color: rgba(41,41,41,0.95)"><?= Yii::$app->formatter->asCurrency($valor_liquido) ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        if ( $valor_total == 0){
                                            ...
                                            $margem = round((($valor_venda/ $valor_total)-1)*100,2)."%";
                                            echo ' <td style="font-weight: bold; color: rgba(41,41,41,0.95)">'.$margem.' </td>';
                                        }
...
<a class="btn btn-primary" href="<?= Url::to(['/pedidos-mercado-livre/index']) ?>" role="button">Voltar</a>
