                        ...
                        <div class="card__content">
                            <div>
                                ...
                                <table class="table">
                                    ...
                                    <!-- valor total -->
                                    <tr>
                                        <th scope="row" style="font-weight: bold; color: rgba(41,41,41,0.95)">Valor Liquido</p></th>
                                        <td></td>
                                        <td></td>
...
<a class="btn btn-primary" href="<?= Url::to(['/pedidos-mercado-livre/mercado-livre-autorizar', 'id'=>$model['id']]) ?>" role="button">Desautorizar</a>
