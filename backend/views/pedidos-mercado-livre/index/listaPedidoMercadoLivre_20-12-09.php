                                ...
                                <div class="container">
                                    ...
                                    <div class="col-sm-3" style="background-color: rgba(74,78,90,0.2); border-radius: 10px">
                                        <table class="table">
                                            ...
                                            <?php
                                            if($valor_venda < $valor_cotacao){



                                                echo '<tr>';
                                                echo '<th scope="row" style="color: red;font-size: 12px; border:none !important;">'."Valor Líquido". '</p></th>';
                                                echo '<td style="border:none !important;"></td>';
                                                echo '<td style="border:none !important;"></td>';
                                                echo '<th scope="row" style="color: red;  font-size: 12px; border:none !important;">'. Yii::$app->formatter->asCurrency($valor_liquido) .'</td>';
                                                echo '</tr>';

                                            }else{
                                                echo '<tr>';
                                                echo '<th scope="row" style="font-size: 12px; border:none !important;">'."Valor Líquido". '</p></th>';
                                                echo '<td style="border:none !important;"></td>';
                                                echo '<td style="border:none !important;"></td>';
                                                echo '<th scope="row" style="font-size: 12px; border:none !important;">'. Yii::$app->formatter->asCurrency($valor_liquido) .'</td>';
                                                echo '</tr>';
