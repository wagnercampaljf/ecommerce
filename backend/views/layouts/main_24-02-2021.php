    ...
    <div class="page-header">
        <div class="page-header-menu">
            ...
            $menuItems = [
                ...
                ['label' => '<i class="fa fa-users"></i> Pesq. Produtos', 'url' => ['/produto/pesquisar']],
                ['label' => '<i class="fa fa-users"></i> Markup', 'url' => ['/markup-mestre/index']],
                ['label' => '<i class="bi bi-cart-plus-fill"></i> Compras', 'url' => ['/pedido-compra/index']],
                //
                //            [
                //                'label' => '<i class="fa fa-info-circle"></i> Ajuda',
                //                'url' => 'https://pecaagora.zendesk.com/hc/pt-br',
