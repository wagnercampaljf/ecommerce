                            ...
                            <div class="col-md-3">
                                ...
                                <ul class="icon-des">
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/pedidos-mercado-livre/index'; ?>"><i class="glyphicon glyphicon-shopping-cart"></i>
                                            <div class="row">Mercado Livre</div>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="mega-menu-wrap">
                        <div class="row">
                            <div class="col-md-2">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li> <a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/categoria/index'; ?>"><i class="fa fa-sitemap"></i><div class="row">Categorias</div></a></li>
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/fabricante/index'; ?>"><i class="fa fa-indent"></i><div class="row">Fabricante</div></a></li>
                                    <li> <a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/imagens'; ?>"><i class="fa fa-file-image-o"></i><div class="row">Imagens</div></a></li>
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/marca-produto'; ?>"><i class="fa fa-maxcdn"></i><div class="row">Marca (Produto)</div></a></li>
                                </ul>
                            </div>
                            <div class="col-md-3">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/marca/index'; ?>"><i class="fa fa-maxcdn"></i><div class="row">Marca</div> </a></li>
                                    <li> <a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/modelo/index'; ?>"><i class="fa fa-list-alt"></i><div class="row">Modelo</div></a></li>
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/produto/index'; ?>"><i class="fa fa-wrench"></i><div class="row">Produtos</div></a></li>
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/sub-categoria/index'; ?>"><i class="fa fa-sitemap"></i><div class="row">SubCategorias</div></a></li>
                    ...
                    <div class="mega-menu-wrap">
                        <div class="row">
                            <div class="col-md-2">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/produto/pesquisar'; ?>"><i class="glyphicon glyphicon-shopping-cart"></i><div class="row">Pesquisar Produto</div></a></li>
                                </ul>
                            </div>
                            <div class="col-md-3">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/produto/movimentacao-estoque'; ?>"><i class="glyphicon glyphicon-search"></i><div class="row">Movimentação Estoque</div></a></li>
                                </ul>
                            </div>
                            <div class="col-md-3">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/formulario-garantia'; ?>"><i class="fa fa-list-alt"></i><div class="row">Garantia</div></a></li>
                                </ul>
                            </div>
                            <!-- <div class="col-md-3">
                                 <h4 class="row mega-title">Relatorios</h4>
                    ...
                    <div class="mega-menu-wrap">
                        <div class="row">
                            <div class="col-md-2">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/filial/index'; ?>"><i class="fa fa-list-alt"></i><div class="row">Filiais</div></a></li>
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/produto-filial'; ?>"><i class="fa fa-dropbox"></i><div class="row">Estoque</div></a></li>
                                </ul>
                            </div>
                            <div class="col-md-4">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li>  <a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/markup-mestre/index'; ?>"><i class="fa fa-th"></i><div class="row">Markup</div></a></li>
                                    <li> <a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/valor-produto-filial'; ?>"><i class="fa fa-money"></i><div class="row">Valor</div></a></li>
                    ...
                    <div class="mega-menu-wrap">
                        <div class="row">
                            <div class="col-md-2">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/pedido-compra/index'; ?>"><i class="fa fa-list-alt"></i><div class="row">Compras</div></a></li>
                                </ul>
                            </div>
                            <div class="col-md-4">
                                <h4 class="row mega-title"></h4>
                                <ul class="icon-des">
                                    <li>  <a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/compradores/index'; ?>"><i class="fa fa-th"></i><div class="row">Compradores</div></a></li>
                                    <li> <a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/banner/index'; ?>"><i class="fa fa-money"></i><div class="row">Anúncios</div></a></li>
