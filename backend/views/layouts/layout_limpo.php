...
<body onload="document.getElementById('chave').focus();">
<?php $this->beginBody() ?>
...
<div class="page-header">
	...
	<div class="clearfix col-md-12 cab_fixo  " id="sumir" style="padding: 1px;  background: linear-gradient(#f7f7f7, #f7f7f7); height: 56px">
        <div class="container">
            <div class="col-xs-2 col-md-2"> 
            	<a href="<?= Yii::$app->urlManager->baseUrl . '/pedidos-mercado-livre/index'; ?>">
	...
	<div class="page-header-menu">
	    ...
	    ['label' => '<i class="fa fa-search"></i> Separação', 'url' => ['/pedidos-mercado-livre-expedicao/separacao']],
	    ['label' => '<i class="fa fa-search"></i> Saída de Mercadorias', 'url' => ['/pedidos-mercado-livre-expedicao/expedicao']],
            ['label' => '<i class="fa fa-tasks"></i> Relação de Notas e Pedidos', 'url' => ['/nota-fiscal/index-nota-pedido']],
            [
                'label' => '<i class="fa fa-power-off"></i> Sair (' . (isset(Yii::$app->user->identity->nome) ? Yii::$app->user->identity->nome : "") . ')',
                'url' => ['/site/logout'],
