...
class Pedido extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['valor_total', 'comprador_id', 'filial_id', 'forma_pagamento_id', 'valor_frete'], 'required'],
            ...
            [['comprador_id', 'compra_filial_id', 'filial_id', 'transportadora_id', 'forma_pagamento_id', 'plp_id', 'administrador_id', 'tipo_frete'], 'integer'],
            ...
            [['e_pedido_autorizado', 'e_email_estoque'], 'boolean'],
        ];
    }
