...
class Produto extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['fabricante_id', 'subcategoria_id', 'marca_produto_id', 'quantidade', 'multiplicador', 'envio', 'ordem', 'filial_id'], 'integer'],
            [['nome'], 'string', 'max' => 150],
    ...
    public function getUrlImage($logo = true)
    {
        ...
        if (!empty($imagens)) {
            ...
            // if ($logo) {
            //     $src = Url::base(true) .'/imagens/produto_' . $this->id . '/' . $this->id . '_' . $ordem . '.webp';
            // } else {
            //     $src = Url::base(true). '/imagens/produto_' . $this->id . '/' . $this->id . '_' . $ordem . '_sem_logo.webp';
            // }
