...
//echo 444444;
	...
	echo "(".$valor_principal.")";
        ...
        if($pedido_mercado_livre_produto){     
            ...
            $valor_envio = ($pedido_mercado_livre->shipping_option_list_cost * 1.2) - ($pedido_mercado_livre->shipping_option_cost);
	    $valor_envio /= $pedido_mercado_livre_produto->quantity;
