...
echo "(222)";
    ...
    public static function criarPedidoOmie($user_id, $response_order, $envio_dados, $billing_info, $e_html, $order)
    {
        ...
        $filial_id = PedidoMercadoLivre::findOne(['pedido_meli_id' => $order])->filial_id;
        $transportadora_id = PedidoMercadoLivre::findOne(['pedido_meli_id' => $order])->transportadora_id;
