 ...
 * @property integer $coluna_derivacao
...
//public $coluna_estoque;
    ...
    public function rules()
    {
        return [
            ...
            [['funcao_id'], 'required'],
            [['coluna_codigo_fabricante','coluna_estoque','coluna_preco', 'coluna_preco_compra','coluna_capas','coluna_nome','coluna_derivacao'], 'integer'],
