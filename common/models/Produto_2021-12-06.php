    ...
    public function getUrlImagesML()
    {
        ...
        if (!empty($imagens)) {
            ...
            foreach ($imagens as $k => $v) {
                if (file_exists("/var/www/html/frontend/web/assets/img/imagens_temporarias/" . $v->id."_".$v->ordem . ".jpg")) {
                    $src[] = ['source' => 'https://www.pecaagora.com/frontend/web/assets/img/imagens_temporarias/' . $v->id."_".$v->ordem . '.jpg'];
                    echo " - Imagem já existente";
                } else {

                    $caminho    = '/var/www/imagens_produto/produto_' . $v->produto_id . '/' . $v->produto_id . '_' . $v->ordem . '.webp';
                    copy($caminho, '/var/www/html/frontend/web/assets/img/imagens_temporarias/' . $v->id."_".$v->ordem . ".webp", stream_context_create($stream_opts));
                    $resultado = shell_exec('cd /var/www/html/frontend/web/assets/img/imagens_temporarias/ ; mogrify -format jpg ' . $v->id."_".$v->ordem . '.webp');
                    $src[] = ['source' => 'https://www.pecaagora.com/frontend/web/assets/img/imagens_temporarias/' . $v->id."_".$v->ordem . '.jpg'];
                    echo " - Imagem criada";
                }
            }
