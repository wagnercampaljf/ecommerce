...
class Comprador extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['nome', 'dt_criacao', 'email'], 'required'],
            ...
            [['cpf'], CnpjValidator::class,'on' => 'juridica'],
            [['cpf'], CpfValidator::class,'on' => 'fisica'],
    ...
    {
        return $this->hasMany(Mensagem::class, ['comprador_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Pedido::class, ['comprador_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(NivelAcesso::class, ['id' => 'nivel_acesso_id']);
    }
    ...
    {
        return $this->hasMany(Carrinho::class, ['comprador_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Visita::class, ['comprador_id' => 'id']);
    }
