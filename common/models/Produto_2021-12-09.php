    ...
    public function getUrlImagesML()
    {
        ...
        /*if (!empty($imagens)) {
            ...
            foreach ($imagens as $k => $v) {          
                    ...
                    $caminho    = '/var/www/imagens_produto/pecaagoraglobal.webp';
                    copy($caminho, '/var/www/html/frontend/web/assets/img/imagens_temporarias/pecaagoraglobal.webp', stream_context_create($stream_opts));
                   // $resultado = shell_exec('cd /var/www/html/frontend/web/assets/img/imagens_temporarias/ ; pecaagoraglobal.jpg');
