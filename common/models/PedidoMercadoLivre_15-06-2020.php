...
class PedidoMercadoLivre extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pedido_meli_id', 'shipping_id', 'status', 'buyer_id', 'buyer_doc_type', 'shipping_service_id', 'receiver_id', 'receiver_address_id', 'receiver_street_number', 'receiver_zip_code', 'receiver_city_id', 'receiver_state_id', 'receiver_country_id', 'receiver_neighborhood_id', 'receiver_municipality_id', 'shipping_option_id', 'shipping_option_name', 'shipping_option_delivery_type', 'user_id'], 'string', 'max' => 20],
            ...
            [['shipping_tracking_method', 'receiver_municipality_name', 'receiver_delivery_preference'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'buyer_first_name' => 'Nome Comprador',
            'buyer_last_name' => 'Sobrenome Comprador',
            ...
            'receiver_phone' => 'Telefone Recebedor',
