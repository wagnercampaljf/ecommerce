...
class PedidoMercadoLivre extends \yii\db\ActiveRecord
{
            ...
            if ($response_order["httpCode"] < 300) {
                ...
                if ($envio_dados['httpCode'] >= 300) {
                    ...
                    if ($pedido_ml->filial_id == null) {
                        ...
                        $status_retorno .= self::criarPedidoOmie($user_id, $response_order, $envio_dados, $billing_info, $e_html, $order, $pedido_ml);
                    }
                } else {
    ...
    public static function criarPedidoOmie($user_id, $response_order, $envio_dados, $billing_info, $e_html, $order, $pedido_ml = null)
    {
        ...
        if (ArrayHelper::getValue($response_omie, 'httpCode') == 200) {
            ...
            if ($pedido_ml) {
                ...
                $cep = substr($pedido_ml->receiver_zip_code, 0, 8);
                ...
                $body = [
                    ...
                    "param" => [
                        ...
                        "endereco"                  => str_replace(" ", "%20", substr($pedido_ml->street_name, 0, 59)),
                        "endereco_numero"           => substr($pedido_ml->street_number, 0, 10),
                        ...
                        "estado"                    => str_replace(" ", "%20", $pedido_ml->receiver_state_id),
        ...
        $aliquota_uf_destino = [
            ...
            'TO' => 0.18, 'SE' => 0.18, 'RR' => 0.17, 'RO' => 0.175, 'RS' => 0.18, 'RN' => 0.18, 'PI' => 0.17, 'PR' => 0.18,
            'PB' => 0.18, 'PE' => 0.18, 'PA' => 0.17
        ];

        $estado = $pedido_ml->receiver_state_id <> null ? $pedido_ml->receiver_state_id : substr(ArrayHelper::getValue($envio_dados, 'body.receiver_address.state.id'), -2);
        ...
        if ($pedido_ml->codigo_pedido_omie <> null) {
            ...
            if ($produto_cotacao_ml) {
                ...
                foreach ($produto_cotacao_ml as $cotacao) {
                    ...
                    $frete          = $pedido_ml->shipping_option_list_cost <> null ? $pedido_ml->shipping_option_list_cost : ArrayHelper::getValue($envio_dados, 'body.shipping_option.cost') - ArrayHelper::getValue($envio_dados, 'body.shipping_option.list_cost');
