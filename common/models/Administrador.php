 ...
 * @property string $codigo_omie_mg_vendas
 *
...
class Administrador extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['codigo_omie_sp', 'codigo_omie_mg', 'codigo_omie_filial', 'codigo_omie_mg_vendas'], 'string', 'max' => 15],
            [['cpf'], 'string', 'max' => 11],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'codigo_omie_mg_vendas' => 'codigo_omie_mg_vendas',
