                    ...
                    <div id="thumbcarousel" class="carousel slide" data-interval="false">
                        <div class="carousel-inner">
                            <div class="item active ">
                                ...
                                }else{echo "<hidden>111111</hidden>";}
                ...
                <div class="panel panel-primary price lead text-center">
                    ...
                    <?php if ($minValue->produtoFilial->estoque > 0) { ?>
                        <div itemprop="offers" itemscope itemtype="http://schema.org/AggregateOffer" class="panel-body">
                            ...
                            <br>
                            <span itemprop="lowPrice"  class="h1 text-success"><?= $minValue->labelTitulo() ?></span>
    ...
    <?php if ($minValue->produtoFilial->estoque > 0) { ?>
        <div class="fab col-sm-1">
            ...
            <div class="col-sm-1 preco">
                <span class="valor" itemprop="lowPrice"><?= $minValue->labelTitulo($juridica) ?> à vista  </span><br>
                <span class="valor" itemprop="lowPrice"><i class="fa fa-credit-card" aria-hidden="true"></i> 6x de <?= number_format(($minValue->getValorFinal($juridica)/ $divide), 2, ',', '') ?></span>
            </div>
            <div class="col-sm-5">
