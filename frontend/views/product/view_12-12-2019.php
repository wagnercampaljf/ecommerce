...
//echo "<script> fbq('track', 'ViewContent', {content_type: 'product', content_ids: [".$produto->id."]}); </script>";
...
//                   echo Html::img($imagem, $options);
            ...
            <?php
                ...
                if(array_search($produto->id, $arrayid)) {
             ?>
...
<script type="text/javascript">
    ...
    <!-- carousel  NOVO- <div class="container hidden-xs">
        <div class="row">
            <div class="col-md-12">
                <h2>Compre Também</h2>
                                ...
                                <div class="col-sm-4">
                                    <div class="thumb-wrapper">
                                        ...
                                        <div class="thumb-content">
                                            ...
                                            <p class="item-price"><strike>R$400.00</strike> <b>R$369.00</b></p>
                                ...
                                <div class="col-sm-4">
                                    <div class="thumb-wrapper">
                                        ...
                                        <div class="thumb-content">
                                            ...
                                            <p class="item-price"><strike>R$25.00</strike> <b>R$23.99</b></p>
                                            <a href="#" class="btn btn-primary">Add No carrinho </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="thumb-wrapper">
                                        ...
                                        <div class="thumb-content">
                                            ...
                                            <p class="item-price"><strike>R$899.00</strike> <b>R$649.00</b></p>
                                            <a href="#" class="btn btn-primary">Add No carrinho </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="thumb-wrapper">
                                        ...
                                        <div class="thumb-content">
                                            <h4>Lanterna dianteira</h4>
                                            <p class="item-price"><strike>R$1099.00</strike> <span>R$869.00</span></p>
                                            <div class="star-rating">
                                                <div class="row">
                                                    <span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star <?= (($produto->id)%5!=1) ? "checked" : ""?>"></span>
                                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="thumb-wrapper">
                                        ...
                                        <div class="thumb-content">
                                            <h4>Faixa traseira</h4>
                                            <p class="item-price"><strike>R$109.00</strike> <span>R$99.00</span></p>
                                            <div class="star-rating">
                                                <div class="row">
                                                    <span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star <?= (($produto->id)%5!=1) ? "checked" : ""?>"></span>
                                                </div>
