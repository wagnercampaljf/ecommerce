...
<div itemscope itemtype="http://schema.org/Product" class="site-product">
    <div class="container header-product-view">
        <h1><span itemprop="name"><?= $produto->label ?> </span></h1>

    </div>
    <div class="panel panel-body">
        <div class="main-product-view">
            <div class="img-product-view text-center  col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <?php
                $options = ['width' => '100%', 'alt' => $produto->getLabel(), 'title' => $produto->getLabel(), 'itemprop' => 'image'];
...
?>
                    ...
                    <div id="thumbcarousel" class="carousel slide" data-interval="false">
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                foreach ($imagens as $k => $imagem) {
                                    echo '<div data-target="#carousel" data-slide-to="'.$k.'" class="thumb">';
                                    echo Html::img($imagem, $options);
                                    echo '</div>';
                                }
				//$imgaviso="https://www.pecaagora.com/frontend/web/assets/img/aviso.png";
            ...
            <div class="details-product-view col-lg-4 col-md-4 col-sm-4 col-sx-12">
                <span class="h4"> <u>Detalhes do Produto</u></span>
            ...
            <div class=" col-lg-4 col-md-4 col-sm-4 col-sx-12">
                <div class="panel panel-primary price lead text-center">
                        ...
                        <div itemprop="offers" itemscope itemtype="http://schema.org/AggregateOffer" class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <a href="" aria-disabled="true" onclick="addProdutoCarrinho('<?= $minValue->produtoFilial->id ?>', this);return false;"
                                   class="btn col-lg-offset-2 col-lg-8  btn-primary <?= ($ativo ?: 'disabled') ?>"><i
                                            class="no-color fa fa-shopping-cart"></i> <?= ($ativo ? "Comprar Agora" : 'Já Adicionado') ?>
                                </a>
                            </div>
                    ...
                    <?php } ?>
                    <small>
                        <small><b><?= $minValue->produtoFilial->filial->nome ?></b></small>
                    </small>
