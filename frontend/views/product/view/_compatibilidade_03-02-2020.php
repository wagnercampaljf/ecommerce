...
<!--    --><?php
//    $categorias = [];
//    foreach ($produto->anosModelo as $anoModelo) {
//        $categorias[$anoModelo->modelo->categoria->nome]
//        [$anoModelo->modelo->marca->label][$anoModelo->modelo->nome][] = $anoModelo;
//    }
//    ?>
<!--    <thead>-->
<!--    --><?php
//    foreach ($categorias as $nomeCategoria => $marcas){
//    ?>
<!--    <tr>-->
<!--        <th><span class="lead">--><? //= $nomeCategoria ?><!--</span></th>-->
<!--        <th></th>-->
<!--        <th></th>-->
<!--        <th></th>-->
<!--    </tr>-->
...
<!--    </thead>-->
<!--<tbody>-->
<?php //foreach ($marcas as $nomeMarca => $modelos) {
//    foreach ($modelos as $nomeModelo => $anoModelo) {
//        ?>
<!--        <tr>-->
<!--            <td>--><? //= $nomeMarca ?><!--</td>-->
<!--            <td>--><? //= $nomeModelo ?><!--</td>-->
<!--            <td>--><? //= implode(' // ', $anoModelo) ?><!--</td>-->
<!--        </tr>-->
<!--        </tbody>-->
<!--        --><?php
//    }
