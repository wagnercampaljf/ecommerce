    ...
    <div class=" col-lg-10 col-lg-offset-1 padmobile col-sm-12 col-md-10 col-md-offset-1" style="padding-bottom: 10px; background: #fff !important;box-shadow: 0px 0px 5px #00000059;">
        ...
        <div class="col-sm-12 ">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-6">
                <?= $form->field($comprador, 'password')->passwordInput(['maxlength' => 255, 'id' => 'passwordFormInput'])->hint('Senha deve conter no minimo 6 caracteres de A-Z a-z 0-9')->label("Senha *") ?>
            ...
            <!--<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <?= $form->field($comprador, 'repeat_password')->passwordInput(['maxlength' => 255])->label("Repetir Senha *") ?>
            </div>-->
