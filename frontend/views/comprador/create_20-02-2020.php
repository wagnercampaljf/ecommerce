...
<div class="comprador-create">
	...
	<div class="col-lg-3 "></div>
		...
		<li role="presentation" class="<?= $activeFisica ?>">
                    <a href="<?= Url::to(['/comprador/create', 'tipoEmpresa' => 'fisica']) ?>">Pessoa Física</a>
                </li>
                <li role="presentation" class="<?= $activeJuridica ?>">
                    <a href="<?= Url::to(['/comprador/create']) ?>">Pessoa Jurídica</a>
                </li>
            </ul>
