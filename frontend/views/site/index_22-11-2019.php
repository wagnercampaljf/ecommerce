...
<div class="container " style="background-color: #f7f7f7; border-radius: 10px">
    <div class="row">
        <div class="col-md-12 col-sm-12 co-xs-12 gal-item"><br>
            <a href="https://www.pecaagora.com/p/18670/carrinho-de-carga-metalosa-camara-180kg-15298cc"><img src="<?= Url::to('@assets/'); ?>img/bannerblack1.jpg"  class="img-ht img-fluid rounded acende img-responsive" alt="imagem responsiva"></a>
        </div>
        <div class="row">
            <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                <div class="row h-50">
                    <div class="col-md-12 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            <a href="https://www.pecaagora.com/p/18670/carrinho-de-carga-metalosa-camara-180kg-15298cc"><img src="<?= Url::to('@assets/'); ?>img/b10.jpg"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva"></a>
                        </div>
                    </div>
                </div>
                <div class="row h-50">
                    <div class="col-md-12 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            <img src="<?= Url::to('@assets/'); ?>img/b5.webp"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-25">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/7499/maquina-vidro-eletrica-ld-direito-iveco-eurocargo-eletrico-eurotech-5801324907"><img src="<?= Url::to('@assets/'); ?>img/b2.webp"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-75">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/262014/ventilador-giratorio-12-volts-especial-grande-08-polegadas-vto-458909  "><img src="<?= Url::to('@assets/'); ?>img/b2.2.webp"   class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>

                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-75">
                    <div class="box">
                        <a href=" https://www.pecaagora.com/p/43931/retentor-traseiro-virabrequim-mercedes-benz-om-447-449-457-219975347 "><img src="<?= Url::to('@assets/'); ?>img/b3.webp" class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva"></a>
                    </div>
                </div>
            </div>
