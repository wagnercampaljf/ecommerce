        ...
        <div class="row">
                        ...
                        <div class="box">
                            <div id="myCarousel" class="carousel slide " data-ride="carousel">
                                ...
                                <div class="carousel-inner ">
                                    ...
                                    <div class="item">
                                        <a href=""><img src="<?= Url::to('@assets/'); ?>img/1B-708x370.1.jpg" width="100%" height="100%"></a>
                                    </div>

                                    <div class="item">
                                        <a href=""><img src="<?= Url::to('@assets/'); ?>img/banner_site_th.jpg" width="100%" height="100%"></a>
                                    </div>
            ...
            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-25">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/222241/disco-tacografo-caminhes-nibus-vans-semanal-125-km-20x20-dml001"><img src="<?= Url::to('@assets/'); ?>img/3A-330x178_3.jpg"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-75">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/370537/kit-estribo-l-e-c-pisantes-mb-axor-2035-2040-2044-2540-2544-2644-k-00090"><img src="<?= Url::to('@assets/'); ?>img/2A-330x178_3.jpg"   class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>

                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-75">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/247982/paralama-traseiro-dir-mb-axor-1933-2533-2831-3131-fibra-direito-grafite-9408802906"><img src="<?= Url::to('@assets/'); ?>img/1A-330x178_3.jpg" class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva"></a>
                    </div>
                </div>
            </div>
