...
<div class="row home-busca col-lg-12 text-center header">
    <div class="row col-lg-12">
        <div id="myCarouselBanner" class="carousel slide hidden-xs" data-ride="carousel">
        	<ol class="carousel-indicators">
                ...
                <li data-target="#myCarouselBanner" data-slide-to="5"></li>
		<li data-target="#myCarouselBanner" data-slide-to="6"></li>
            </ol>
        	<div class="carousel-inner">
		<div class="item active">
                        <div class="row col-lg-12">
                        <div class="hidden-xs col-lg-12 col-xs-12 col-sm-12 col-md-12 ">
                ...
                <div class="item">
                	<div class="row col-lg-12">
                        <div class="hidden-xs col-lg-12  col-xs-12 col-sm-12 col-md-12 ">
                            <a href="https://www.pecaagora.com/p/238131/roda-7-5-x-22-5-10-furos-caminho-carreta-vw-mb-ford-iveco-volvo-scania-vc1216"><img src="<?= Url::to('@assets/'); ?>img/3.webp" width="100%" height="100%"></a>
                        </div>
                    </div>
                </div>
                <div class="item">
        ...
        <div class="row col-lg-12 visible-xs">
