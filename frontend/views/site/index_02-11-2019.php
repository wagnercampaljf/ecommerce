...
<div class="container " style="background-color: #f7f7f7; border-radius: 10px">
    <div class="row">
        <div class="col-md-12 col-sm-12 co-xs-12 gal-item"><br>
            <a href="https://www.pecaagora.com/p/18670/carrinho-de-carga-metalosa-camara-180kg-15298cc"><img src="<?= Url::to('@assets/'); ?>img/bannerblack.jpg"  class="img-ht img-fluid rounded acende img-responsive" alt="imagem responsiva"></a>
        </div>
        <div class="row">
