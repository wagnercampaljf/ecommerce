        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                ...
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-75">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/10830/chave-seta-preta-mb-mercedes-benz-1938-s-L54134"><img src="<?= Url::to('@assets/'); ?>img/bannerprod2.jpg"   class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>
            ...
            <div id="myCarouselOferta" class="carousel slide" data-ride="carousel" >
                ...
                <div class="carousel-inner">
                    ...
                    if (!YII_DEBUG) {
                        ...
                        $arrayid = [316327, 28942, 229939, 251843, 38614, 275078, 222292, 222293, 222248, 222241, 231596, 231618, 222500, 222503, 222505, 222513, 222515, 222517, 222518, 222523,222496, 222528, 247475, 227171, 231646, 231647, 249999, 231651, 231348, 231514, 41523, 56129, 222494, 231648, 316326, 257602];
                    }
