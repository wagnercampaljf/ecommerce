            ...
            <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                <div class="row h-50">
                    <div class="col-md-12 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            <a href="https://www.pecaagora.com/p/55992/farol-principal-caminhao-mb-axor-lado-direito-mercedes-benz-9408200261"><img src="<?= Url::to('@assets/'); ?>img/banner-inicial.jpg"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva"></a>
                        </div>
                    </div>
                </div>
                <div class="row h-50">
