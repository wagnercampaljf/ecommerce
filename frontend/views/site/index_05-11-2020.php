        ...
        <div class="row">
            <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                        ...
                        <div class="box">
                            <div id="myCarousel" class="carousel slide " data-ride="carousel">
                                ...
                                <div class="carousel-inner ">
                                    ...
                                    <div class="item active">
                                       <a href="https://www.pecaagora.com/p/369645/par-ponteira-parachoque-le-ld-vw-man-tgx-direito-esquerdo-p-2v5805903 "><img src="<?= Url::to('@assets/'); ?>img/banner-caroulsel26.jpg" width="100%" height="100%"></a>
                                    </div>

                                    <div class="item">
                                     <a href=" https://www.pecaagora.com/p/55992/farol-principal-caminhao-mb-axor-lado-direito-mercedes-benz-9408200261">  <img src="<?= Url::to('@assets/'); ?>img/banner-carousel24.jpg" width="100%" height="100%"></a>
                                    </div>
                                    <div class="item">
                                     <a href="https://www.pecaagora.com/p/323174/forro-teto-courvim-mb-1113-1113-1313-1513-2013-2213-1519-com-bolsa-preto-3446957025"><img src="<?= Url::to('@assets/'); ?>img/banner-carousel20.jpg" width="100%" height="100%"></a>
                                    </div>
                                </div>
                ...
                <div class="row h-50">
                    <div class="col-md-12 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            <img src="<?= Url::to('@assets/'); ?>img/banner70.jpg"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-25">
                    <div class="box">
                        <a href=" https://www.pecaagora.com/p/348746/paralama-cavalo-carreta-rt-basculante-carretas-semi-reboque-randon-2000-a-2007-208007065  "><img src="<?= Url::to('@assets/'); ?>img/banner-carousel25.jpg"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-75">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/231651/leo-15w40-ci4-motor-diesel-truck-turbo-20-litros-k15w40"><img src="<?= Url::to('@assets/'); ?>img/banner-carousel21.jpg"   class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>

                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-75">
                    <div class="box">
                        <a href=" https://www.pecaagora.com/p/286254/par-forro-porta-preto-cabine-alta-mb-1113-1313-1513-1519-1520-2013-2213-furo-quadrado-mercedes-benz-3317277071"><img src="<?= Url::to('@assets/'); ?>img/banner-carousel23.jpg" class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva"></a>
                    </div>
                </div>
            </div>
