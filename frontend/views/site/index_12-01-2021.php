        ...
        <div class="row">
                        ...
                        <div class="box">
                            <div id="myCarousel" class="carousel slide " data-ride="carousel">
                                ...
                                <div class="carousel-inner ">
                                    ...
                                    <div class="item active">
                                       <a href="https://www.pecaagora.com/p/257500/forro-teto-caminhao-mb-1113-1513-1114-1518-2013-cabine-alta-com-bolsa-preto-pvc-087020"><img src="<?= Url::to('@assets/'); ?>img/NATAL-3B-708x370.jpg" width="100%" height="100%"></a>
                                    </div>
                                    <div class="item">
                                     <a href="https://www.pecaagora.com/p/369448/par-forro-porta-cinza-vw-690s-790s-7110s-11130-13130-14140-ate-2000-p-tf3867016-tf3867015">  <img src="<?= Url::to('@assets/'); ?>img/NATAL-1B-708x370.jpg" width="100%" height="100%"></a>
                                    </div>
                                    <div class="item">
                                     <a href="https://www.pecaagora.com/p/369806/tapete-mb-709-710-912-914-borracha-texturizado-com-nome-com-logo-mercedes-benz-138115"><img src="<?= Url::to('@assets/'); ?>img/NATAL-2B-708x370.jpg" width="100%" height="100%"></a>
                                    </div>
                                </div>
                ...
                <div class="row h-50">
                    <div class="col-md-12 col-sm-12 co-xs-12 gal-item">
                        <div class="box">
                            ...
                            <img src="<?= Url::to('@assets/'); ?>img/natal-1C-708x178.jpg"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                <div class="col-md-12 col-sm-6 co-xs-12 gal-item h-25">
                    <div class="box">
                        <a href="https://www.pecaagora.com/p/222241/disco-tacografo-caminhes-nibus-vans-semanal-125-km-20x20-dml001"><img src="<?= Url::to('@assets/'); ?>img/3A-330x178.jpg"  class="img-ht img-fluid rounded acende img-responsive" style="width:100%; height: 100%" alt="imagem responsiva">
                    </div>
                </div>
