...
?>
    ...
    <!-- web -->
    <div class="clearfix col-md-12 cab_fixo hidden-xs " style="padding: 1px;  background: linear-gradient(#f7f7f7, #f7f7f7); height: 66px">
        <div class="col-lg-2 col-sm-4 col-xs-12 logo-wrap hidden-xs" style="margin-top:-5px;margin-bottom: 10px;z-index: 99">
            <div>
                <a href="<?= Url::to(['/']) ?>">
                    <img style="width: 198px; height:63px; padding-top: 5px " class="logo" alt="Peca Agora" title="Peça Agora"
        ...
        <div class="row hidden-xs">
            <div class="col">
                <a rel="nofollow" href="<?= Url::to(['/carrinho']) ?>" class="cart-wrap pull-left" style="padding: -0px; color: #040100 !important;">
                    <img src="https://img.icons8.com/color/44/000000/shopping-cart.png"/>
    ...
    <!-- mobile -->
    <div id="header" class="header nav-ontop nav-resize " >
        ...
        <div class="">
            <div class="row">
                ...
                <div class="col-xs-4"><a rel="nofollow" href="<?= Url::to(['/carrinho']) ?>" class="cart-wrap pull-left" style="padding: -0px; color: #040100 !important;">
                        <img src="https://img.icons8.com/color/20/000000/shopping-cart.png"/>
                        <span class="badge cart-count"><?= count(Yii::$app->session['carrinho']) ?></span>
            ...
            <div class="col-xs-6 col-sm-4 col-md-5 header-search-box">
            ...
            <div class="col-xs-3 col-sm-1 col-md-1 col-xs-1  group-button-header">
                ...
                <div class="pull-left col-lg-6 col-sm-9 col-md-9 col-xs-2 hidden-mobile colzero" style="margin-top: -1px">

                    <?php if (Yii::$app->user->isGuest) { ?>
                    <span class="text-cad mobile_none hidden-xs">

                        <a rel="nofollow" style="font-weight: bold; font-size: 14px; color: #000000" href="<?= Url::to(['/site/login']) ?>">Entre ou</a></br>
                        <a rel="nofollow" style="font-weight: bold; font-size: 14px; color: #000000" href="<?= Url::to(['/comprador/create?tipoEmpresa=fisica']) ?>">Cadastre-se</a>
                    </span>
                    <?php } else { ?>
                    <span class="text-cad mobile_none hidden-xs">
    ...
    <div class="row" style="background-color: #007576">
        ...
        <div class="footer-sitemap-col col-sm-3" style="padding: 20px">
            ...
            <ul class="list-unstyled">
               ...
               <!-- <li><a style="color: white" rel="nofollow" href="<?= Yii::$app->urlManager->baseUrl . '/site/tuto_comprar'; ?>">Tutorial de como comprar</a></li>-->
