...
?>
    ...
    <div class="header hidden-xs"><!-- navbar-fixed-top -->
        <div class="menu-sup text-left nav <?php if (Url::base(true) . '/' != Yii::$app->getRequest()->absoluteUrl) { echo "hidden-xs"; } ?>">
            <img src="<?= Url::to('@assets/'); ?>img/bannertopoblack.jpg"  style="width: 100%; text-align: center">
            <!--
            <ul class="top-list">
                <li>
    ...
    <div class="menuCategoria clearfix row">
        ...
        <nav id="w1" class="navbar navbar-inverse nav-cats">
            <div class="container" STYLE="background-color: #040100"><div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#w1-collapse"><span class="sr-only">Toggle navigation</span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span></button><a class="navbar-brand" href=".navbar-collapse" rel="nofollow" data-toggle="collapse">Departamentos</a></div><div id="w1-collapse" class="collapse navbar-collapse"><ul id="w2" class="navbar-nav nav"><li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/acabamentos-e-cabine" data-toggle="dropdown"><h3>Acabamentos e Cabine <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w3" class="dropdown-menu"><li><h3><a href="/auto/acabamentos-e-cabine/espelhos-retrovisores-e-componentes" tabindex="-1">Espelhos Retrovisores e Componentes</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/acessorios" data-toggle="dropdown"><h3>Acessórios <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w4" class="dropdown-menu"><li><h3><a href="/auto/acessorios/capa-protetora" tabindex="-1">Capa Protetora</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/agropet" data-toggle="dropdown"><h3>Agropet <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w5" class="dropdown-menu"><li><h3><a href="/auto/agropet/agropet" tabindex="-1">Agropet</a></h3></li></ul></li>
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/autopecas" data-toggle="dropdown"><h3>Autopeças <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w6" class="dropdown-menu"><li><h3><a href="/auto/autopecas/cabos" tabindex="-1">Cabos</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/baterias" data-toggle="dropdown"><h3>Baterias <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w7" class="dropdown-menu"><li><h3><a href="/auto/baterias/carregadores-de-baterias" tabindex="-1">Carregadores de Baterias</a></h3></li></ul></li>
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/cardan" data-toggle="dropdown"><h3>Cardan <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w8" class="dropdown-menu"><li><h3><a href="/auto/cardan/garfo" tabindex="-1">Garfo</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/colas-e-adesivos" data-toggle="dropdown"><h3>Colas e adesivos <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w9" class="dropdown-menu"><li><h3><a href="/auto/colas-e-adesivos/colas-e-adesivos" tabindex="-1">Colas e adesivos</a></h3></li></ul></li>
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/diversos" data-toggle="dropdown"><h3>Diversos <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w10" class="dropdown-menu"><li><h3><a href="/auto/diversos/diversos" tabindex="-1">Diversos</a></h3></li></ul></li>
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/embreagem" data-toggle="dropdown"><h3>Embreagem <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w11" class="dropdown-menu"><li><h3><a href="/auto/embreagem/kit-de-embreagem-leves" tabindex="-1">Kit de Embreagem Leves</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/ferragens" data-toggle="dropdown"><h3>Ferragens <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w12" class="dropdown-menu"><li><h3><a href="/auto/ferragens/ferragens" tabindex="-1">Ferragens</a></h3></li></ul></li>
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/ferramentas" data-toggle="dropdown"><h3>Ferramentas <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w13" class="dropdown-menu"><li><h3><a href="/auto/ferramentas/ferramentas" tabindex="-1">Ferramentas</a></h3></li>
                                <li><h3><a href="/auto/ferramentas/cavaletes" tabindex="-1">Cavaletes</a></h3></li></ul></li>
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/filtros" data-toggle="dropdown"><h3>Filtros <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w14" class="dropdown-menu"><li><h3><a href="/auto/filtros/filtro-de-ar" tabindex="-1">Filtro de Ar</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/freios" data-toggle="dropdown"><h3>Freios <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w15" class="dropdown-menu"><li><h3><a href="/auto/freios/junta" tabindex="-1">Junta</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/motor" data-toggle="dropdown"><h3>Motor <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w16" class="dropdown-menu"><li><h3><a href="/auto/motor/virabrequim" tabindex="-1">Virabrequim</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/oleo" data-toggle="dropdown"><h3>Óleo <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w17" class="dropdown-menu"><li><h3><a href="/auto/oleo/graxa-rolamento" tabindex="-1">Graxa Rolamento</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/pinturas" data-toggle="dropdown"><h3>Pinturas <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w18" class="dropdown-menu"><li><h3><a href="/auto/pinturas/pintura" tabindex="-1">Pintura</a></h3></li></ul></li>
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/pneus" data-toggle="dropdown"><h3>Pneus <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w19" class="dropdown-menu"><li><h3><a href="/auto/pneus/pneus-aro-13" tabindex="-1">Pneus Aro 13</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/servicos-automotivos" data-toggle="dropdown"><h3>Serviços Automotivos <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w20" class="dropdown-menu"><li><h3><a href="/auto/servicos-automotivos/servicos-de-motor" tabindex="-1">Serviços de Motor</a></h3></li>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle disabled" href="/auto/suspensao" data-toggle="dropdown"><h3>Suspensão <b class="fa fa-caret-right pull-right"></b></h3></a><ul id="w21" class="dropdown-menu"><li><h3><a href="/auto/suspensao/peas-suspenso" tabindex="-1">Peças Suspensão</a></h3></li>
                                <li><h3><a href="/auto/suspensao/amortecedor-a-gas-tampa" tabindex="-1">Amortecedor a gás tampa</a></h3></li>
                                <li><h3><a href="/auto/suspensao/amortecedores" tabindex="-1">Amortecedores</a></h3></li></ul></li></ul></div></div></nav>
