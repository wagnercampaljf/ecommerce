...
<div class="clearfix col-md-12 cab_fixo" style="padding: 15px;  background: linear-gradient(#004546, white);">
    ...
    <?php if (Yii::$app->user->isGuest) { ?>
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-9 hidden-xs" style="border-width: 2px;border-style: dashed; border-color: #000000;">
            <i class="pull-left fa fa-user-o fa-3x" aria-hidden="true"></i>
            <span style="font-weight: bold; color: black"> Olá, Bem vindo(a)</span><br>
            <a rel="nofollow" style="font-weight: bold; font-size: 16px" href="<?= Url::to(['/site/login']) ?>">Entre </a>
            <span> ou </span>
            <a rel="nofollow" style="font-weight: bold; font-size: 16px" href="<?= Url::to(['/comprador/create?tipoEmpresa=fisica']) ?>"> Cadastre-se</a>
        </div>
    <?php } else { ?>
    ...
    <a rel="nofollow" href="<?= Url::to(['/carrinho']) ?>" class="cart-wrap pull-left" style="padding: -0px">
