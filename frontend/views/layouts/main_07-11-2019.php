...
?>
    ...
    <div class="header hidden-xs"><!-- navbar-fixed-top -->
        <div class="menu-sup text-left nav <?php if (Url::base(true) . '/' != Yii::$app->getRequest()->absoluteUrl) { echo "hidden-xs"; } ?>">
            <img src="<?= Url::to('@assets/'); ?>img/bannertopo101.jpg"  style="width: 100%; text-align: center">
            <!--
            <ul class="top-list">
                <li>
    ...
    <div class="clearfix col-md-12 cab_fixo" style="padding: 15px;  background: linear-gradient(#f7f7f7, #f7f7f7); height: 66px">
