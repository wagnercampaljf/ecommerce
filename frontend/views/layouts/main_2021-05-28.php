...
?>
	...
	<script src="<?= yii::$app->urlManager->baseUrl . '/frontend/web/js/jquery-1.8.3.min.js' ?>" type="text/javascript"></script>
        ...
        <noscript><img height="1" width="1" style="display:none"
                       src="https://www.facebook.com/tr?id=465917450866477&ev=PageView&noscript=1"
            /></noscript>
    ...
    <div class="header hidden-xs"><!-- navbar-fixed-top -->
        <div class="menu-sup text-left nav <?php if (Url::base(true) . '/' != Yii::$app->getRequest()->absoluteUrl) { echo "hidden-xs"; } ?>">
            <img src="<?= Url::to('@assets/'); ?>img/banner-padrao-topol2.jpg"  style="width: 100%; text-align: center">
            <!--
            <ul class="top-list">
                <li>
    ...
    <div class="clearfix col-md-12 cab_fixo  " id="sumir" style="padding: 1px;  background: linear-gradient(#f7f7f7, #f7f7f7); height: 56px">
        <div class="container">
            ...
            <div class="col-xs-2 col-md-2"> <a href="<?= Url::to(['/']) ?>">
                        <img style="padding-top: 5px; width: 180px " class="logo" alt="Peca Agora" title="Peça Agora"
                             src="<?= Url::to('@assets/'); ?>img/pecaagora_padrao.png">
                    </a></div>
            <div class="col-xs-7 col-md-7" style="padding-top: 6px">  <?php //if (Url::base(true) . '/' != Yii::$app->getRequest()->absoluteUrl) { ?><?php //} ?>
        ...
        <div class="">
            <div class="row">
                ...
                <div class="col-xs-4" style="text-align: center">
                    <a href="<?= Url::to(['/']) ?>">
                        <img  alt="Peca Agora" title="Peça Agora"
                              src="<?= Url::to('@assets/'); ?>img/pecaagora_padrao.png">
                    </a></div>
    ...
    <style>
        ...
        @media (max-width: 1299px)and (min-width: 1293px){
            #menu-negocio ul li .prof-jardinagem{display:none}
        }
        ...
        @media (max-width: 1155px) and (min-width: 1030px){
            #menu-negocio ul li .prof-jardinagem{display:none}
            #menu-negocio ul li .prof-fulinaria{display:none}
        }

        @media (max-width: 1029px) and (min-width: 920px){
            #menu-negocio ul li .prof-jardinagem{display:none}
            #menu-negocio ul li .prof-fulinaria{display:none}
            #menu-negocio ul li .prof-cosntrucao{display:none}
        }
        ...
        @media (max-width: 849px) and (min-width: 720px){
            ...
            #menu-negocio ul li .prof-fulinaria{display:none}
            #menu-negocio ul li .prof-cosntrucao{display:none}
            #menu-negocio ul li .prof-industria{display:none}
                    ...
                    <li class="dropdown side-dropdown">
                        ...
                        <div class="custom-menu">
                            <div class="row">
                                <div class="col-md-8" style=" line-height:8px !important;">
                                    <ul class="list-links">
                                        <li ><h3 class="list-links-title">Baterias</h3></li><li ><a href="/search?nome=Carregadores de Baterias">Carregadores de Baterias</a></li><li ><a href="/search?nome=ATACADAO">Atacadão</a></li>        </ul>
                                </div>
                            </div>
                        </div>
                    </li><li class="dropdown side-dropdown">
