...
<div class="wrap">
    <div class="header row navbar-fixed-top">
        ...
        <div class="clearfix col-md-12" style="margin-bottom: 5px;padding-top: 15px">
            <div class="row col-md-3 col-lg-2 col-sm-4 col-xs-12 logo-wrap hidden-xs" style="margin-top: -5px;margin-bottom: 10px;z-index: 99">
                <div>
                    <a href="<?= Url::to(['/']) ?>">
            ...
            <?php if (Yii::$app->user->isGuest) { ?>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-9" style="border-width: 2px;border-style: dashed; border-color: #007576;">
                    <i class="pull-left fa fa-user-o fa-3x" aria-hidden="true"></i>
                    <span> Olá, Bem vindo(a)</span><br>
                    <a rel="nofollow" style="font-weight: bold; font-size: 15px" href="<?= Url::to(['/site/login']) ?>">Entre </a>
                    <span> ou </span>
                    <a rel="nofollow" style="font-weight: bold; font-size: 15px" href="<?= Url::to(['/comprador/create?tipoEmpresa=fisica']) ?>"> Cadastre-se</a>
                </div>
            <?php } else { ?>
...
<li><h3><a href="/auto/suspensao/amortecedores" tabindex="-1">Amortecedores</a></h3></li></ul></li></ul></div></div></nav>        
    ...
    <footer class="footer">
	    ...
	    <p class="text-center">www.pecaagora.com / OPT Soluções Comércio de Produtos e Serviços Automotivos LTDA /
            	CNPJ nº 18.947.338/0001-10 / 
            	Inscrição Estadual 0026402800023 / 
            	Peça Agora MG - Rua José Lourenço Kelmer, s/nº, UFJF - CRITT, Juiz de Fora – MG - 36036-900 / 
				Peça Agora SP - Rua Carmópolis de Minas, 963, Vila Maria - São Paulo - SP - 02116-010
            </p>
