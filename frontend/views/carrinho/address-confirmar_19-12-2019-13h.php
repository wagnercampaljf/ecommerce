            ...
            <div class="row">
                <?php
                    ...
                    echo $form->field($empresa, 'telefone',['options' => ['class' => 'form-group col-lg-4 col-md-4 col-sm-4 col-xs-12']])->textInput(['maxlength' => 18,
                        'data-mask'=>'(00) 00000-0000'])->label("Telefone *");
                ?>
            </div>
            <div class="row">
                <div class="clearfix">
                ...
                <?= $form->field($model, 'numero',['options' => ['class' => 'form-group col-lg-3 col-md-3 col-sm-3 col-xs-12']])->textInput(['maxlength' => true, 'type' => 'number' ]) ?>
