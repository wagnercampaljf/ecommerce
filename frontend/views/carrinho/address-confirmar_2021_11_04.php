    ...
    <div class="panel panel-primary comprador-view endereco-empresa-form">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <?= $form->field($model, 'logradouro')->textInput(['maxlength' => true,'required'=>true,'readonly'=>true]) ?>
            ...
            <div class="row">
				<?= $form->field($model, 'bairro')->textInput(['maxlength' => true,'required'=>true,'readonly'=>true]) ?>
                <?= $form->field($model, 'cidade')->textInput(['value' => $model->cidade, 'required'=>true,'readonly'=>true])->label("Cidade") ?>
            </div>
            <div class="row">
