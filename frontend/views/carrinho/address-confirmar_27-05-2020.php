    ...
    <div class="panel panel-primary comprador-view endereco-empresa-form">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <?php
                    ...
                    if (($comprador->cpf == null or str_replace(" ","",$comprador->cpf) == "") && ArrayHelper::getValue($empresa, 'juridica') == false) {
                        ...
                        echo $form->field($comprador,'cpf',['options' => ['class' => 'form-group col-lg-4 col-md-4 col-sm-4 col-xs-12']])->textInput(['maxlength' => 14, 'required'=>true,])->hint("Somente números")->label("CPF *");
                        echo '</div>';
                    }
                    
                    echo $form->field($empresa, 'telefone',['options' => ['class' => 'form-group col-lg-4 col-md-4 col-sm-4 col-xs-12']])->textInput(['maxlength' => 18,
                        'data-mask'=>'00000000000', 'required'=>true,])->label("Telefone *");
                ?>
            </div>
            <div class="row">
                <div class="clearfix">
                ...
                <?= $form->field($model, 'numero',['options' => ['class' => 'form-group col-lg-3 col-md-3 col-sm-3 col-xs-12']])->textInput(['maxlength' => true, 'type' => 'number', 'required'=>true, ]) ?>
            ...
            <div class="row">
                ...
                <?= $form->field($model, 'cidade')->textInput(['value' => $model->cidade, 'required'=>true])->label("Cidade") ?>
            </div>
            <div class="row">
