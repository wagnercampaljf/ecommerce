                ...
                <div class="panel">
                    <div class="col-md-12">
                        ...
                        foreach ($produtos as $produto) :
                            $ValorProdutoMenorMaior   = ValorProdutoMenorMaior::find()->andWhere(['=', 'produto_id', $produto->produto_id])->one();
                            $valor_prod = $ValorProdutoMenorMaior['menor_valor'];
                        ?>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="text-left col-md-12">
                                                    <div class=" container-frete">
                                                        <div id="resultado-frete<?= $filial_id ?>" class="resultado-frete " data-filial-id="<?= $filial_id ?>" data-cep="<?= Yii::$app->params['getCepComprador'](true) ?>">
                                        ...
                                        <div class="text-right col-md-6">
                                            <?= $produto->produto->getImage(['width' => '80%']) ?>
                                            <div class="">
                                                <p class="text-">
                                    ...
                                    <?= Html::activeHiddenInput(
                                        $pedido,
                                        "[$filial_id][pedidoProdutoFilials]" . '[' . $produto->id . ']valor_total',
                                        ['value' => $valor_prod]
                                    ) ?>
                        ...
                        <div class="panel-footer">
                            <p class="text-success text-right h3"> Total:
                                <span class="grow total-filial" id="valorTotal_<?= $filial_id ?>" data-valor-total="<?= $valorTotal ?>" data-filial-id="<?= $filial_id ?>">
                                    <?= $valorTotal ?>
                                </span>
                                <?= Html::activeHiddenInput(
                                    $pedido,
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        ...
                        <div class="row">
                            ...
                            )->textInput(['maxlength' => true, 'type' => 'number', 'id' => 'numero-comprador']) ?>
                            <?= $form->field(
                                $model,
                                'complemento',
                                ['options' => ['class' => 'form-group col-lg-3 col-md-3 col-sm-3 col-xs-12']]
                            )->textInput(['maxlength' => true, 'id' => 'complemento-comprador']) ?>
                        </div>
                        <div class="row">
        ...
        <div class="panel-body " id="formadepagamento">
            ...
            <div class="row text-center" id="">
                <div class="col-lg-6 col-md-4 col-sm-8 col-xs-12 ">
                    <a href="#moip_creditCard"> <button style="margin-left: 5px;width: 220.83px" type="button" class="btn btn-bubble" data-forma-pagamento="moip_creditCard" id="btn-moip">
                ...
                <div class="col-lg-6 col-md-4 col-sm-8 col-xs-12  " style="align-items: center">
                    <a href="#moip_boleto"> <button style="margin-left: 5px; width: 220.83px" type="button" class="btn btn-bubble" data-forma-pagamento="moip_boleto" id="btn-moip">
                ...
                <div class="col-md-12 text-right h3">
                    ...
                    <br><br>
                    <p class="alert alert-warning h5">
                        <i class="glyphicon glyphicon-exclamation-sign"></i>
                        ATENÇÃO - Taxa Fixa de Encargo Financeiro: <?= Yii::$app->formatter->asCurrency(Moip::TAXMOIP) ?>.
                    </p>
                </div>
            </div>
            <br> <br>
