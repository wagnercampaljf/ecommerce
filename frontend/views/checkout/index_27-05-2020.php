                    ...
                    <div class="container cartão" style="background-color: rgba(255,255,255,0.05); border-radius: 10px;">
                        ...
                        <div class="panel-body" >
                            <div class="col2">
                                ...
                                <div class="row">
                                    <?= $form->field($formPagamento, 'ccNumber')->textInput(['maxlength' => 22, 'class'=>'number form-group col-lg-3 col-md-3 col-sm-3 col-xs-12']) ?>
                                    <?= $form->field($formPagamento, 'name')->textInput(['class'=> 'inputname form-group col-lg-3 col-md-3 col-sm-3 col-xs-12']); ?>
                                    <?= $form->field($formPagamento, 'cvcNumber')->textInput(['maxlength' => 4, 'class'=>'ccv form-group col-lg-3 col-md-3 col-sm-3 col-xs-12']) ?>
