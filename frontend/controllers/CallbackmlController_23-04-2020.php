...
class CallbackmlController extends Controller
{
	...
	/*$post_ml = [
		...
		echo "<pre>"; print_r($response_order); echo "</pre>";
		...
		echo "<pre>"; print_r($envio_dados); echo "</pre>"; die;
			    ...
			    "telefone1_ddd"             => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.receiver_phone'),0,5),
                            "telefone1_numero"          => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.receiver_phone'),0,15),
                            "contato"                   => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.receiver_name'),0,100),
                            "endereco"                  => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.street_name'),0,60),
                            "endereco_numero"           => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.street_number'),0,10),
                            "bairro"                    => substr(((ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.neighborhood.name')=="") ? "Centro" : ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.neighborhood.name')),0,30),
                            "complemento"               => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.comment'),0,40),
                            "estado"                    => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.state.id'),-2),
                            "cidade"                    => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.city.name'),0,40),
                            "cep"                       => substr(ArrayHelper::getValue($response_order, 'body.shipping.receiver_address.zip_code'),0,10),
