...
Skype: pecaagora";
	    ...
	    $pedido_mercado_livre->email_assunto = "{estoque} - Pedido {codigo_fabricante} * {quantidade} - {nome} ({margem}) - {pedido_meli_id}";
	    if($pedido_mercado_livre->user_id == "435343067"){
		$pedido_mercado_livre->email_assunto = "{estoque} - Novo Pedido {codigo_fabricante} * {quantidade} - {nome} ({margem}) - {pedido_meli_id}";
	    }
