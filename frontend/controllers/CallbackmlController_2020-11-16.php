    ...
    public function criarPedidoMercadoLivre($order = null, $shipping = null){
		...
		//var_dump($pedido_mercado_livre->save()); die;
                ...
                if($pedido_mercado_livre_shipments){
                    ...
                    $pedido_mercado_livre_shipments->receiver_address_delivery_preference   = (string) (isset($shipping["body"]->receiver_address->delivery_preference)) ? ArrayHelper::getValue($shipping, 'body.receiver_address.delivery_preference') : "";
                    ...
                    $pedido_mercado_livre_shipments->shipping_option_shipping_method_id     = (string) (isset($shipping["body"]->shipping_option->shipping_method_id)) ? ArrayHelper::getValue($shipping, 'body.shipping_option.shipping_method_id') : "";
                    ...
                    $pedido_mercado_livre_shipments->delivery_type                          = (string) (isset($shipping["body"]->shipping_option->delivery_type)) ? ArrayHelper::getValue($shipping, 'body.shipping_option.delivery_type') : "";
                    ...
                    $pedido_mercado_livre_shipments->type                                   = (string) (isset($shipping["body"]->type)) ? ArrayHelper::getValue($shipping, 'body.type') : "";
                    $pedido_mercado_livre_shipments->logistic_type                          = (string) (isset($shipping["body"]->logistic_type)) ? ArrayHelper::getValue($shipping, 'body.logistic_type') : "";
                    $pedido_mercado_livre_shipments->application_id                         = (string) (isset($shipping["body"]->application_id)) ? ArrayHelper::getValue($shipping, 'body.application_id') : "";
