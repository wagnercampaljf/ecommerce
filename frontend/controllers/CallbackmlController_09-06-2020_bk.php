...
class CallbackmlController extends Controller
{
    ...
    public function criarPedidoMercadoLivre($order, $shipping){
        
        echo "<pre>"; print_r($order); echo "</pre>";
        echo "<pre>"; print_r($shipping); echo "</pre>";die;
        
        var_dump(ArrayHelper::getValue($order, 'body.id'));
        ...
        if($pedido_mercado_livre){
            ...
            var_dump($pedido_mercado_livre->save());
            if($pedido_mercado_livre->save()){
                echo "<br><br><br>Pedido alterado";
            }
            else{
                echo "<br><br><br>Pedido não alterado";
            }
        }
        else{
            $pedido_mercado_livre = new PedidoMercadoLivre();
            ...
            var_dump($pedido_mercado_livre->save());
            if($pedido_mercado_livre->save()){
                echo "<br><br><br>Pedido criado";
            }
            else{
                echo "<br><br><br>Pedido não criado";
            }
        }
        ...
        if($pedido_mercado_livre){
            ...
            if(!is_null($shipping)){
                ...
                $pedido_mercado_livre->shipping_option_list_cost            = (string) ArrayHelper::getValue($shipping, 'body.shipping_option.list_cost');
                $pedido_mercado_livre->shipping_option_cost                 = (string) ArrayHelper::getValue($shipping, 'body.shipping_option.cost');
            ...
            foreach(ArrayHelper::getValue($order, 'body.payments') as $k => $pagamento){
                echo "<pre>"; print_r($pagamento); echo "</pre>";
