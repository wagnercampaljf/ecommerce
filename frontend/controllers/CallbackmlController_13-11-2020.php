    ...
    public function criarPedidoMercadoLivre($order = null, $shipping = null){
		...
		//var_dump($pedido_mercado_livre->save()); die;
                ...
                if($pedido_mercado_livre_shipments){
                    ...
                    $pedido_mercado_livre_shipments->order_cost                             = (string) ArrayHelper::getValue($shipping, 'body.order_cost');
                    ...
                    $pedido_mercado_livre_shipments->history_date_cancelled                 = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_cancelled'),0,19));
                    $pedido_mercado_livre_shipments->history_date_delivered                 = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_delivered'),0,19));
                    $pedido_mercado_livre_shipments->history_date_first_visit               = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_first_visit'),0,19));
                    $pedido_mercado_livre_shipments->history_date_handling                  = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_handling'),0,19));
                    $pedido_mercado_livre_shipments->history_date_not_delivered             = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_not_delivered'),0,19));
                    $pedido_mercado_livre_shipments->history_date_ready_to_ship             = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_ready_to_ship'),0,19));
                    $pedido_mercado_livre_shipments->history_date_shipped                   = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_shipped'),0,19));
                    $pedido_mercado_livre_shipments->history_date_returned                  = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.status_history.date_returned'),0,19));
                    $pedido_mercado_livre_shipments->date_created                           = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.date_created'),0,19));
                    $pedido_mercado_livre_shipments->last_updated                           = str_replace("T", " ",substr(ArrayHelper::getValue($shipping, 'body.last_updated'),0,19));
                    ...
                    $pedido_mercado_livre_shipments->receiver_address_delivery_preference   = (string) ArrayHelper::getValue($shipping, 'body.receiver_address.delivery_preference');
                    ...
                    $pedido_mercado_livre_shipments->shipping_option_shipping_method_id     = (string) ArrayHelper::getValue($shipping, 'body.shipping_option.shipping_method_id');
                    ...
                    $pedido_mercado_livre_shipments->delivery_type                          = (string) ArrayHelper::getValue($shipping, 'body.shipping_option.delivery_type');
                    ...
                    $pedido_mercado_livre_shipments->type                                   = (string) ArrayHelper::getValue($shipping, 'body.type');
                    $pedido_mercado_livre_shipments->logistic_type                          = (string) ArrayHelper::getValue($shipping, 'body.logistic_type');
                    $pedido_mercado_livre_shipments->application_id                         = (string) ArrayHelper::getValue($shipping, 'body.application_id');
                    ...
                    //echo "<pre>===>>"; var_dump($pedido_mercado_livre_shipments); echo "<<==="; die;
