...
class ProdutoSearch extends Produto
{
	...
	$order_preco = 'valor';
	    ...
	    '"produto"."slug"',
            ...
            //'fabricante',
            //'filiaisProduto.filial.enderecoFilial.cidade',
            //'filiaisProduto.filial.caracteristicas',
    ...
    private function searchNome(&$query)
    {
		...
		"ts_headline(
                ...
                '@@',
                'produto.texto_vetor',
                new Expression("to_tsquery('tsc_pt_unaccent',unaccent('$textAnd'))")
            ])->orFilterWhere([
                'like',
                'produto.codigo_global',
                new Expression($codigo_global_filtro)
